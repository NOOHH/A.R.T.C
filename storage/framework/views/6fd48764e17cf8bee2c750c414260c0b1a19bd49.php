...
<link href="<?php echo e(asset('css/admin/admin-modules.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<div class="modules-container">
    ...
    <div class="action-buttons">
        ...
        <?php if(isset($isPreview) && $isPreview): ?>
            <a href="/t/draft/<?php echo e(session('preview_tenant')); ?>/admin/modules/archived?website=<?php echo e(request('website')); ?>" class="view-archived-btn">
                <i class="bi bi-archive"></i> View Archived
            </a>
            <a href="/t/draft/<?php echo e(session('preview_tenant')); ?>/admin/quiz-generator?website=<?php echo e(request('website')); ?>" class="quiz-generator-btn">
                <i class="bi bi-robot"></i> AI Quiz Generator
            </a>
        <?php else: ?>
            <a href="<?php echo e(route('admin.modules.archived')); ?>" class="view-archived-btn">
                <i class="bi bi-archive"></i> View Archived
            </a>
            <a href="<?php echo e(route('admin.quiz-generator')); ?>" class="quiz-generator-btn">
                <i class="bi bi-robot"></i> AI Quiz Generator
            </a>
        <?php endif; ?>
    </div>
      ...
      <div class="module-header" onclick="toggleModule(<?php echo e($module->modules_id); ?>)">
        ...
        <div class="module-actions" onclick="event.stopPropagation();">
          <div class="action-btn-group">
            <button class="action-btn-green add-btn" onclick="showAddCourseModal(<?php echo e($module->modules_id); ?>, '<?php echo e($escapedModuleName); ?>')"><i class="bi bi-plus-circle"></i> Add Course</button>
            <button class="action-btn-green edit-btn" onclick="editModule(<?php echo e($module->modules_id); ?>)" title="Edit Module"><i class="bi bi-pencil"></i></button>
            <button class="action-btn-green archive-btn" onclick="archiveModule(<?php echo e($module->modules_id); ?>)" title="Archive Module"><i class="bi bi-archive"></i></button>
            <button class="action-btn-green override-btn" onclick="openOverrideModal('module', <?php echo e($module->modules_id); ?>, '<?php echo e($escapedModuleName); ?>')"><i class="bi bi-sliders"></i> Override</button>
          </div>
        </div>
      </div>
        ...
        viewerBody.innerHTML = `
            <div class="content-display">
                <div class="quiz-preview">
                    ...
                    <div class="mt-3">
                        <a href="<?php echo e(route('admin.quiz-generator')); ?>" class="btn btn-primary" target="_blank">
            ...
            <div class="content-item" data-content-id="${item.id}" onclick="loadContentInViewer(${item.id}, '${item.content_type}', '${item.content_title}', ${moduleId}, ${courseId})" style="cursor: pointer;">
                ...
                <div class="content-item-actions" onclick="event.stopPropagation();">
                    <div class="action-btn-group">
                        ...
                        <?php $escapedContentTitle = isset($item) ? addslashes($item->content_title) : ''; ?>
...
<div class="modal-bg" id="addModalBg">
    <div class="modal">
        ...
        <form action="<?php echo e(route('admin.modules.store')); ?>" method="POST" enctype="multipart/form-data" id="addModuleForm">
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/admin/admin-modules/admin-modules.blade.php ENDPATH**/ ?>