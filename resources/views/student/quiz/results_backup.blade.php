...
<div class="results-container">
    ...
    <div class="results-header">
        ...
        <div class="score-display">{{ number_format($attempt->score, 1) }}%</div>
    ...
    <div class="action-buttons mb-4">
        ...
        @if($canRetake)
            @if($contentId)
                <a href="{{ route('student.content.view', $contentId) }}" class="btn btn-success btn-lg">
                    <i class="bi bi-arrow-repeat"></i> Retake Quiz
                </a>
            @else
                <button id="retake-quiz-btn" class="btn btn-success btn-lg" onclick="retakeQuiz({{ $quiz->quiz_id }})">
                    <i class="bi bi-arrow-repeat"></i> Retake Quiz
                </button>
            @endif
        @endif
