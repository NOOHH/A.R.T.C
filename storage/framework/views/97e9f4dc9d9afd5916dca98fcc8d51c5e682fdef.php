            ...
            <div class="card shadow border-0">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        ...
                        Edit: <?php echo e($professor->full_name); ?>

                    </h5>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('admin.professors.update', $professor->professor_id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="first_name" name="first_name" value="<?php echo e(old('first_name', $professor->first_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="last_name" name="last_name" value="<?php echo e(old('last_name', $professor->last_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="email" name="email" value="<?php echo e(old('email', $professor->email)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                               ...
                                               value="<?php echo e(old('referral_code', $professor->referral_code)); ?>" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   <?php echo e($professor->programs->contains('program_id', $program->program_id) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($professor->programs->count() > 0): ?>
                            <div class="mb-4">
                                ...
                                <div class="accordion" id="videoAccordion">
                                    <?php $__currentLoopData = $professor->programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="accordion-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="url" class="form-control video-link" 
                                                               ...
                                                               data-program-id="<?php echo e($program->program_id); ?>"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control video-description" 
                                                                  data-professor-id="<?php echo e($professor->id); ?>"
                                                                  data-program-id="<?php echo e($program->program_id); ?>"
                                                                  rows="2" placeholder="Brief description of the video content"><?php echo e($program->pivot->video_description); ?></textarea>
                                                    </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="<?php echo e(route('admin.professors.index')); ?>" class="btn btn-secondary">Cancel</a>
            ...
            <div class="card shadow border-0 mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <form action="<?php echo e(route('admin.professors.assign-batch', $professor->professor_id)); ?>" method="POST" class="row g-3">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-8">
                                <select name="batch_id" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($batch->batch_id); ?>">
                                            <?php echo e($batch->batch_name); ?> - <?php echo e($batch->program->program_name ?? 'N/A'); ?> 
                    ...
                    <div>
                        ...
                        <?php if($assignedBatches->count() > 0): ?>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $assignedBatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                ...
                                                <td><?php echo e($batch->professor_assigned_at ? $batch->professor_assigned_at->format('M d, Y') : 'N/A'); ?></td>
                                                <td>
                                                    <form action="<?php echo e(route('admin.professors.unassign-batch', [$professor->professor_id, $batch->batch_id])); ?>" 
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\professors\edit.blade.php ENDPATH**/ ?>