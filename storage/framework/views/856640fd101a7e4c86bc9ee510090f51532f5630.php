    ...
    <div class="modules-container">
        ...
        <div id="contentDisplayArea">
            <?php if(request('program_id')): ?>
                ...
                <?php if(isset($archivedCourses) && $archivedCourses->count() > 0): ?>
                    <?php $__currentLoopData = $archivedCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="course-section collapsed" id="course-<?php echo e($course->subject_id); ?>">
                            <div class="course-header">
                                ...
                                <div class="course-meta">
                                    <div class="course-info">
                                        ...
                                        <span class="course-stat">
                                            <i class="fas fa-archive"></i>
                                            <?php echo e($course->contentItems->count()); ?> archived items
                                        </span>
                                    </div>
                                    <div class="course-actions">
                            ...
                            <div class="course-content">
                                <div class="content-grid">
                                    <?php $__currentLoopData = $course->contentItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="content-card <?php echo e($content->content_type); ?>-content" 
                                            ...
                                            <?php if($content->content_data): ?>
                                                <div class="content-details">
                                                    <?php $data = json_decode($content->content_data, true) ?? [] ?>
                ...
                <?php if((!isset($archivedModules) || $archivedModules->count() == 0) && (!isset($archivedCourses) || $archivedCourses->count() == 0)): ?>
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\admin-modules\admin-modules-archived-new.blade.php ENDPATH**/ ?>