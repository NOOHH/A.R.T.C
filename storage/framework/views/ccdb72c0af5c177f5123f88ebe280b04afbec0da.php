<div style="width: 900px; height: 650px; border: 4px solid #222; padding: 0; background: #fff; font-family: Arial, sans-serif; position: relative;">
    <div style="display: flex; justify-content: space-between; align-items: flex-start; padding: 20px 40px 0 40px;">
        <img src="<?php echo e(asset('resources/images/ARTC_Logo.png')); ?>" alt="Logo" style="height: 90px;">
        <div style="text-align: right;">
            <img src="<?php echo e(asset('resources/images/sample1.png')); ?>" alt="Writing" style="height: 70px; border-radius: 50%; border: 4px solid #fff; box-shadow: 0 0 8px #ccc;">
        </div>
    </div>
    ...
    <div style="margin: 20px 0 0 0; text-align: center; font-size: 1.1rem; color: #222; line-height: 1.5;">
        has successfully ENROLLED in ASCENDO Review and Training Center <span style="font-style: italic;"><?php echo e($batch); ?></span><br>
        Program Details:<br>
        <span style="font-weight: bold; margin: 10px 0; display: block;"><?php echo e($program_details); ?></span>
        
        <?php if($plan_type === 'modular' && !empty($module_names)): ?>
            <div style="margin-top: 15px;">
                ...
                <div style="font-size: 1.0rem; margin-top: 8px; text-align: left; max-width: 600px; margin-left: auto; margin-right: auto;">
                    <?php $__currentLoopData = $module_names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduleName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(strpos($moduleName, '  • Courses:') === 0): ?>
                            <div style="margin-left: 20px; font-style: italic; color: #666;"><?php echo e($moduleName); ?></div>
                        <?php else: ?>
                            <div style="margin: 5px 0; font-weight: bold;">• <?php echo e(strtoupper($moduleName)); ?></div>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        <?php elseif($plan_type === 'modular'): ?>
    ...
    <div style="position: absolute; left: 40px; bottom: 80px; font-size: 0.9rem; color: #444;">
        Date of Completion: <span style="font-weight: bold;"><?php echo e($completion_date); ?></span>
    </div>
    ...
    <div style="position: absolute; right: 40px; bottom: 40px;">
        <img src="<?php echo e($qr_code_src); ?>" alt="QR Code" style="height: 90px;">
    </div>
</div>
    </div>
    <div style="position: absolute; right: 40px; bottom: 40px;">
...
</div> <?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\components\certificate.blade.php ENDPATH**/ ?>