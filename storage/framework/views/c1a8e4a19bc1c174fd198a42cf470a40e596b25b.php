                ...
                <div class="sidebar-section" id="homepage-settings" style="display: none;">
                    ...
                    <form id="homepageForm" onsubmit="updateHomepage(event)" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="copyright" value="<?php echo e($settings['homepage']['copyright'] ?? '© Copyright Your Company Name. All Rights Reserved.'); ?>" placeholder="Footer copyright">
                        </div>
                    ...
                    <form id="studentForm" onsubmit="updateStudent(event)">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="color-picker-group">
                                    <input type="color" class="color-input" id="studentSidebarPrimary" value="<?php echo e($settings['student_sidebar']['primary_color'] ?? '#1a1a1a'); ?>" onchange="updateStudentSidebarColor('primary', this.value)">
                                    <input type="text" class="form-control" id="studentSidebarPrimaryText" name="student_sidebar[primary_color]" value="<?php echo e($settings['student_sidebar']['primary_color'] ?? '#1a1a1a'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="color-picker-group">
                                    <input type="color" class="color-input" id="studentSidebarSecondary" value="<?php echo e($settings['student_sidebar']['secondary_color'] ?? '#2d2d2d'); ?>" onchange="updateStudentSidebarColor('secondary', this.value)">
                                    <input type="text" class="form-control" id="studentSidebarSecondaryText" name="student_sidebar[secondary_color]" value="<?php echo e($settings['student_sidebar']['secondary_color'] ?? '#2d2d2d'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="color-picker-group">
                                    <input type="color" class="color-input" id="studentSidebarAccent" value="<?php echo e($settings['student_sidebar']['accent_color'] ?? '#3b82f6'); ?>" onchange="updateStudentSidebarColor('accent', this.value)">
                                    <input type="text" class="form-control" id="studentSidebarAccentText" name="student_sidebar[accent_color]" value="<?php echo e($settings['student_sidebar']['accent_color'] ?? '#3b82f6'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <label class="form-label">Text Color</label>
                                <div class="color-picker-group">
                                    <input type="color" class="color-input" id="studentSidebarText" value="<?php echo e($settings['student_sidebar']['text_color'] ?? '#e0e0e0'); ?>" onchange="updateStudentSidebarColor('text', this.value)">
                                    <input type="text" class="form-control" id="studentSidebarTextText" name="student_sidebar[text_color]" value="<?php echo e($settings['student_sidebar']['text_color'] ?? '#e0e0e0'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="color-picker-group">
                                    <input type="color" class="color-input" id="studentSidebarHover" value="<?php echo e($settings['student_sidebar']['hover_color'] ?? '#374151'); ?>" onchange="updateStudentSidebarColor('hover', this.value)">
                                    <input type="text" class="form-control" id="studentSidebarHoverText" name="student_sidebar[hover_color]" value="<?php echo e($settings['student_sidebar']['hover_color'] ?? '#374151'); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div id="studentSidebarPreview" class="sidebar-preview" style="
                                --preview-primary: <?php echo e($settings['student_sidebar']['primary_color'] ?? '#1a1a1a'); ?>;
                                --preview-secondary: <?php echo e($settings['student_sidebar']['secondary_color'] ?? '#2d2d2d'); ?>;
                                --preview-accent: <?php echo e($settings['student_sidebar']['accent_color'] ?? '#3b82f6'); ?>;
                                --preview-text: <?php echo e($settings['student_sidebar']['text_color'] ?? '#e0e0e0'); ?>;
                                --preview-hover: <?php echo e($settings['student_sidebar']['hover_color'] ?? '#374151'); ?>;
