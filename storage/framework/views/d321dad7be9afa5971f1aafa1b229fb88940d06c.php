...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', App\Helpers\UIHelper::getSiteTitle()); ?></title>
    ...
    <?php echo App\Helpers\UIHelper::getPageHead(); ?>
    ...
    <!-- Custom CSS -->
            <link rel="stylesheet" href="<?php echo e(asset('css/homepage/navbar.css')); ?>?v=<?php echo e(time()); ?>">
    <style>
        <?php echo \App\Helpers\SettingsHelper::getNavbarStyles(); ?>

        <?php echo \App\Helpers\SettingsHelper::getFooterStyles(); ?>

        <?php echo \App\Helpers\SettingsHelper::getProgramCardStyles(); ?>
...
<body class="body-background d-flex flex-column min-vh-100 <?php if(request()->routeIs('enrollment.*')): ?> enrollment-page <?php endif; ?>">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-white shadow-sm">
        <div class="container-fluid">
            ...
            ?>
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e($brandHref); ?>">
                <img src="<?php echo e($logoUrl); ?>" 
                     alt="Logo" class="logo me-2" style="height: 40px;"
                     data-fallback="<?php echo e(asset('images/ARTC_Logo.png')); ?>" onerror="this.src=this.getAttribute('data-fallback')">
                    ...
                    <li class="nav-item dropdown">
                        <?php if(session('user_id')): ?>
                            ...
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarUserDropdown" role="button" 
                               data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi bi-person-circle"></i> <?php echo e(explode(' ', session('user_name'))[0] ?? 'User'); ?>

                            </a>
                            <ul class="dropdown-menu">
                                <?php if(session('user_role') === 'student'): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('student.dashboard')); ?>">
                                        <i class="bi bi-speedometer2"></i> Dashboard
                                    </a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('student.settings')); ?>">
                                        <i class="bi bi-gear"></i> Settings
                                    </a></li>
                                <?php elseif(session('user_role') === 'admin'): ?>
                                ...
                                <li>
                                    <form action="<?php echo e(route('student.logout')); ?>" method="POST" style="display: inline;">
                                        <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                ?>
                                <li><a class="dropdown-item" href="<?php echo e($tenantLoginUrl); ?>">
                                    <i class="bi bi-box-arrow-in-right"></i> Login
                                </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(url('/signup')); ?>">
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>