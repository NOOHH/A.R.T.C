    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="<?php echo e(route('professor.quiz-generator')); ?>" class="btn btn-outline-secondary me-2">
...
function changeQuestionType(questionId, questionType) {
    const optionsContainer = document.getElementById(`question-options-${questionId}`);
                ...
                fetch(`<?php echo e(route('professor.quiz-generator.question.options')); ?>`, {
        method: 'POST',
        headers: {
...
function saveAllQuestions() {
    ...
    // Save to server
                fetch(`<?php echo e(route('professor.quiz-generator.questions.update', $quiz->quiz_id)); ?>`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('professor.professor-layouts.professor-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\Quiz Generator\professor\quiz-questions-edit.blade.php ENDPATH**/ ?>