        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" id="professor_sidebar_width" class="form-control" placeholder="280" min="200" max="400" value="{{ $settings['professor_sidebar']['width'] ?? '280' }}">
                    <small class="form-text text-muted">Width in pixels (200-400px)</small>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Collapsed Width</label>
                    <input type="number" id="professor_sidebar_collapsed_width" class="form-control" placeholder="70" min="50" max="100" value="{{ $settings['professor_sidebar']['collapsed_width'] ?? '70' }}">
