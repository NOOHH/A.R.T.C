                ...
                <div class="sidebar-section active" id="general-settings">
                    ...
                    <form id="generalForm" onsubmit="updateGeneral(event)">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="site_title" value="{{ $selectedWebsite->name ?? 'Your Training Center' }}" placeholder="Enter website title">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="email" class="form-control" name="contact_email" value="{{ Auth::guard('smartprep')->user()->email }}" placeholder="Contact email">
                        </div>
                ...
                <div class="preview-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="preview-controls">
                            ...
                            <a href="/t/{{ $selectedWebsite->slug }}" class="preview-btn" target="_blank">
