...
@section('title', 'Board Exam Passers Management')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="{{ route('admin.board-passers.download-template') }}" class="btn btn-outline-secondary">
            ...
            <div class="card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0" id="totalPassers">{{ $stats['total_passers'] ?? 0 }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-danger text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0" id="totalNonPassers">{{ $stats['total_non_passers'] ?? 0 }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0" id="passRate">{{ $stats['pass_rate'] ?? 0 }}%</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0" id="lastUpdated">{{ $stats['last_updated'] ?? 'Never' }}</h4>
                ...
                <table class="table table-striped table-hover" id="passersTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $passer->student_name }}</td>
                            <td>{{ $passer->program ?? 'Unknown' }}</td>
                            <td>{{ $passer->board_exam }}</td>
                            <td>{{ $passer->exam_year }}</td>
                            <td>{{ $passer->exam_date ? \Carbon\Carbon::parse($passer->exam_date)->format('M d, Y') : 'N/A' }}</td>
                            <td>
                                <span class="badge {{ $passer->result === 'PASS' ? 'bg-success' : 'bg-danger' }}">
                                    {{ $passer->result }}
                                </span>
                            </td>
                            <td>{{ $passer->rating ? number_format($passer->rating, 2) : 'N/A' }}</td>
                            <td>{{ Str::limit($passer->notes, 30) ?? 'N/A' }}</td>
                            <td>
                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="editPasser({{ $passer->id }})">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-danger" onclick="deletePasser({{ $passer->id }})">
