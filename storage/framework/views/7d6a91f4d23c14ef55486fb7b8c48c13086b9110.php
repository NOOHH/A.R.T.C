...
<?php $__env->startSection('title', 'Create New Batch'); ?>
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('admin.batches.store')); ?>" method="POST">
                                ...
                                <select class="form-select" id="program_id" name="program_id" required>
                                    ...
                                    <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($program->program_id); ?>" 
                                                <?php echo e(old('program_id') == $program->program_id ? 'selected' : ''); ?>>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="max_capacity" name="max_capacity" 
                                       value="<?php echo e(old('max_capacity', 10)); ?>" min="1" max="100" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="batch_status" name="batch_status" required>
                                    <option value="available" <?php echo e(old('batch_status') == 'available' ? 'selected' : ''); ?>>Available</option>
                                    <option value="ongoing" <?php echo e(old('batch_status') == 'ongoing' ? 'selected' : ''); ?>>Ongoing</option>
                                    <option value="closed" <?php echo e(old('batch_status') == 'closed' ? 'selected' : ''); ?>>Closed</option>
                                    <option value="completed" <?php echo e(old('batch_status') == 'completed' ? 'selected' : ''); ?>>Completed</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="registration_deadline" 
                                       name="registration_deadline" value="<?php echo e(old('registration_deadline')); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="duration_weeks" 
                                       name="duration_weeks" value="<?php echo e(old('duration_weeks', 12)); ?>" 
                                       min="1" max="52" step="1">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="end_date" 
                                       name="end_date" value="<?php echo e(old('end_date')); ?>" readonly>
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select" id="professor_id" name="professor_id">
                                    ...
                                    <?php if(isset($professors) && $professors->count() > 0): ?>
                                        <?php $__currentLoopData = $professors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $professor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($professor->professor_id); ?>" 
                                                    <?php echo e(old('professor_id') == $professor->professor_id ? 'selected' : ''); ?>>
                                                <?php echo e($professor->professor_first_name); ?> <?php echo e($professor->professor_last_name); ?>

                                                <?php if($professor->professor_specialization): ?>
                                                    - <?php echo e($professor->professor_specialization); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('admin.batches.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\admin-student-enrollment\create-batch.blade.php ENDPATH**/ ?>