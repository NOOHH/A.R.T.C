...
<?php $__env->startSection('title', 'Archived Programs'); ?>

<?php $__env->startPush('styles'); ?>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/admin/admin-programs.css')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="programs-container">
    ...
    <div class="programs-header">
        ...
        <div class="header-actions">
            <a href="<?php echo e(route('admin.programs.index')); ?>" class="action-btn action-btn-secondary">
    ...
    <!-- Stats Summary -->
    <?php if($archivedPrograms->count() > 0): ?>
    <div class="stats-summary">
        <div class="stat-item">
            <div class="stat-value"><?php echo e($archivedPrograms->count()); ?></div>
            <div class="stat-label">Archived Programs</div>
        </div>
        <div class="stat-item">
            <div class="stat-value"><?php echo e($archivedPrograms->sum('enrollments_count') ?? 0); ?></div>
    ...
    <div class="programs-grid">
        <?php $__empty_1 = true; $__currentLoopData = $archivedPrograms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="card-header">
                    <div class="card-selection">
                        <input type="checkbox" 
                               ...
                               onchange="toggleProgramSelection(<?php echo e($program->program_id); ?>, this)">
                    </div>
                ...
                <div class="card-content">
                    ...
                    <div class="program-stats">
                        <div class="stat-row">
                            ...
                            <span><?php echo e($program->enrollments_count ?? 0); ?> past enrollments</span>
                        </div>
                    </div>
                </div>

                <div class="program-actions">
                    <form action="<?php echo e(route('admin.programs.toggle-archive', $program->program_id)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
                    ...
                    <form action="<?php echo e(route('admin.programs.delete', $program->program_id)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="empty-state">
                ...
                <div class="empty-description">
                    <a href="<?php echo e(route('admin.programs.index')); ?>" class="empty-link">
                        <i class="fas fa-arrow-left"></i>
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\admin-programs\admin-programs-archived.blade.php ENDPATH**/ ?>