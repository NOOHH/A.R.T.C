...
<div class="submissions-container">
    <div class="d-flex justify-content-between align-items-center mb-4 px-2">
        ...
        <a href="<?php echo e(route('professor.modules.index')); ?>" class="btn btn-lg text-white fw-semibold px-4 py-2 rounded-pill shadow back-to-modules-btn">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    <div class="bg-light p-3 rounded">
                        ...
                        <strong><?php echo e($assignedPrograms->count()); ?></strong>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="bg-light p-3 rounded">
                ...
                <div class="col-md-3 mb-3">
                    <div class="bg-light p-3 rounded">
                        ...
                        <strong><?php echo e($submissions->where('grade', '!=', null)->count()); ?></strong>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card h-100">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <span class="badge bg-<?php echo e($status === 'graded' ? 'success' : ($isLate ? 'warning' : 'primary')); ?>">
                                    <?php echo e($status === 'graded' ? 'Graded' : ($isLate ? 'Late' : 'Submitted')); ?>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center me-3" style="width: 50px; height: 50px;">
                                        <?php echo e(strtoupper(substr($submission->student->firstname ?? 'S', 0, 1))); ?><?php echo e(strtoupper(substr($submission->student->lastname ?? 'T', 0, 1))); ?>

                                    </div>
                                    <div>
                                        <h5 class="card-title mb-1"><?php echo e($submission->student->firstname ?? 'Unknown'); ?> <?php echo e($submission->student->lastname ?? 'Student'); ?></h5>
                                        <small class="text-muted"><?php echo e($submission->student->email ?? 'No email'); ?></small>
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <small class="text-muted">Submitted</small>
                                    <div class="fw-semibold"><?php echo e($submission->created_at->format('M d, Y g:i A')); ?></div>
                                </div>
                                ...
                                <?php if($submission->comments): ?>
                                    <div class="bg-light p-3 rounded mb-3">
                                        ...
                                        <div class="mt-1"><?php echo e($submission->comments); ?></div>
                                    </div>
                                <?php endif; ?>

                                <?php if($submission->grade !== null): ?>
                                    <div class="alert alert-success">
                                        <strong>Grade:</strong> <?php echo e($submission->grade); ?><?php echo e(($submission->module && !empty($submission->module->content_data['max_points'])) ? '/' . $submission->module->content_data['max_points'] : ''); ?>
                            ...
                            <div class="card-footer bg-transparent">
                                <div class="d-flex gap-2">
                                    <?php if($submission->processed_files && count($submission->processed_files) > 0): ?>
                                        <a href="<?php echo e(route('professor.submissions.download', $submission->id)); ?>" class="btn btn-info btn-sm">
                                            <i class="fas fa-download me-1"></i>Download
                                        </a>
                                    <?php endif; ?>
                                    
                                    <button class="btn btn-primary btn-sm" onclick="openGradingModal(<?php echo e($submission->id); ?>)">
                                        <i class="fas fa-<?php echo e($submission->grade !== null ? 'edit' : 'star'); ?> me-1"></i><?php echo e($submission->grade !== null ? 'Edit Grade' : 'Grade'); ?>
...
<div class="container-fluid px-4">
    ...
    <div class="filter-section">
        <form method="GET" action="<?php echo e(route('professor.submissions.index')); ?>" class="row g-3">
            <div class="col-md-4">
                ...
                <select name="program_id" id="program_id" class="form-select">
                    ...
                    <?php $__currentLoopData = $assignedPrograms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($program->program_id); ?>" 
                                <?php echo e($programId == $program->program_id ? 'selected' : ''); ?>>
            ...
            <div class="col-md-4">
                ...
                <select name="module_id" id="module_id" class="form-select">
                    ...
                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($module->modules_id); ?>" 
                                <?php echo e($moduleId == $module->modules_id ? 'selected' : ''); ?>>
            ...
            <div class="col-md-2">
                ...
                <select name="status" id="status" class="form-select">
                    ...
                    <option value="graded" <?php echo e($status === 'graded' ? 'selected' : ''); ?>>Graded</option>
                    <option value="reviewed" <?php echo e($status === 'reviewed' ? 'selected' : ''); ?>>Reviewed</option>
                </select>
            </div>
            <div class="col-md-2">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="stats-card">
                ...
                <div class="stats-number"><?php echo e($submissions->total()); ?></div>
        ...
        <div class="col-md-3">
            <div class="stats-card">
                ...
                <div class="stats-number"><?php echo e($submissions->where('status', 'pending')->count()); ?></div>
        ...
        <div class="col-md-3">
            <div class="stats-card">
                ...
                <div class="stats-number"><?php echo e($submissions->where('status', 'graded')->count()); ?></div>
        ...
        <div class="col-md-3">
            <div class="stats-card">
                ...
                <div class="stats-number"><?php echo e($submissions->where('status', 'reviewed')->count()); ?></div>
                ...
                <div class="submission-header">
                    <div class="student-info">
                        ...
                        <div class="student-details">
                            <h5><?php echo e($submission->student->firstname ?? 'Unknown'); ?> <?php echo e($submission->student->lastname ?? 'Student'); ?></h5>
                            <p class="text-muted mb-0">
                                <i class="bi bi-envelope me-1"></i><?php echo e($submission->student->email ?? ($submission->student->user->email ?? 'No email')); ?>

                            </p>
                        </div>
                    </div>
                    <div class="submission-status status-<?php echo e($submission->status); ?>">
                        <i class="bi bi-<?php echo e($submission->status === 'pending' ? 'clock' : ($submission->status === 'graded' ? 'check-circle' : 'eye-check')); ?> me-1"></i>
                ...
                <div class="submission-body">
                    ...
                    <div class="submission-metadata">
                        <div class="metadata-item">
                            ...
                            <div class="metadata-value"><?php echo e($submission->program->program_name ?? 'N/A'); ?></div>
                        </div>
                        <div class="metadata-item">
                            <div class="metadata-label">Module</div>
                            <div class="metadata-value"><?php echo e($submission->module->module_name ?? 'N/A'); ?></div>
                        </div>
                        <div class="metadata-item">
                            <div class="metadata-label">Submitted</div>
                            <div class="metadata-value"><?php echo e($submission->submitted_at ? $submission->submitted_at->format('M d, Y H:i') : 'N/A'); ?></div>
                        </div>
                        <div class="metadata-item">
                            <div class="metadata-label">Assignment Title</div>
                            <div class="metadata-value"><?php echo e($submission->assignment_title ?? 'N/A'); ?></div>
                        </div>
                    </div>
                    ...
                    <?php if($submission->assignment_description): ?>
                        <div class="assignment-details">
                            ...
                            <p class="mb-0"><?php echo e($submission->assignment_description); ?></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($submission->processed_files && count($submission->processed_files) > 0): ?>
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <?php $__currentLoopData = $submission->processed_files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-6 col-lg-4 mb-2">
                                        <div class="file-preview">
                                            <div class="file-icon">
                                                ...
                                                ?>
                                                <i class="bi bi-file-earmark-<?php echo e(str_contains($fileName, '.pdf') ? 'pdf' : (str_contains($fileName, '.doc') ? 'word' : 'text')); ?>"></i>
                                            </div>
                                            <div class="file-info">
                                                <strong><?php echo e($fileName); ?></strong>
                                                <br>
                                                <small class="text-muted"><?php echo e($file['size'] ?? 'Unknown size'); ?></small>
                                                <br>
                                                <a href="<?php echo e($file['path'] ?? $file['file_path'] ?? '#'); ?>" class="btn btn-sm btn-download btn-action mt-2" target="_blank">
                    ...
                    <div class="grading-section">
                        <?php if($submission->grade !== null): ?>
                            ...
                            <div class="grade-display">
                                <h4 class="mb-1">
                                    <i class="bi bi-trophy me-2"></i>Grade: <?php echo e($submission->grade); ?>/100
                                </h4>
                                <small>Graded on <?php echo e($submission->graded_at ? $submission->graded_at->format('M d, Y H:i') : 'N/A'); ?></small>
                            </div>
                            
                            <?php if($submission->feedback): ?>
                                <div class="feedback-section">
                                    <h6><i class="bi bi-chat-text me-1"></i>Feedback</h6>
                                    <p class="mb-0"><?php echo e($submission->feedback); ?></p>
                                </div>
                            <?php endif; ?>

                            <div class="text-center mt-3">
                                <button class="btn btn-outline-primary btn-action" onclick="openGradingModal(<?php echo e($submission->id); ?>)">
                        ...
                        <?php else: ?>
                            ...
                            <div class="text-center">
                                ...
                                <button class="btn btn-grade btn-action" onclick="openGradingModal(<?php echo e($submission->id); ?>)">
    ...
    <?php else: ?>
        ...
        <div class="empty-state">
            ...
            <a href="<?php echo e(route('professor.submissions.index')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('professor.professor-layouts.professor-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\professor\submissions\index.blade.php ENDPATH**/ ?>