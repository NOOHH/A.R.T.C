...
<div class="container-fluid">
    ...
    <div class="program-header">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <h1 class="h2 mb-3">{{ $program->program_name }}</h1>
                <p class="mb-3 opacity-90">{{ $program->program_description ?? 'No description available.' }}</p>
                <div class="d-flex flex-wrap">
                    <div class="stat-badge">
                        <i class="bi bi-people"></i>
                        <span>{{ $program->students->count() }} Students</span>
                    </div>
                    <div class="stat-badge">
                        <i class="bi bi-book"></i>
                        <span>{{ $program->modules->count() }} Modules</span>
                    </div>
                    <div class="stat-badge">
                        <i class="bi bi-calendar"></i>
                        <span>Created {{ $program->created_at->format('M Y') }}</span>
                    </div>
                </div>
            </div>
            @php
                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="text-center p-3 bg-primary bg-gradient rounded-3 text-white">
                                ...
                                <h4 class="mb-1">{{ $program->students->count() }}</h4>
                        ...
                        <div class="col-md-4">
                            <div class="text-center p-3 bg-success bg-gradient rounded-3 text-white">
                                ...
                                <h4 class="mb-1">{{ $program->modules->count() }}</h4>
                        ...
                        <div class="col-md-4">
                            <div class="text-center p-3 bg-info bg-gradient rounded-3 text-white">
                                ...
                                <h4 class="mb-1">{{ $program->created_at->diffForHumans() }}</h4>
            ...
            <div class="detail-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <h5 class="card-title d-flex align-items-center">
                        ...
                        Course Modules ({{ $program->modules->count() }})
                    </h5>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="card module-card h-100 shadow-sm" style="min-height: 280px;">
                                        <div class="card-body d-flex flex-column">
                                            <div class="d-flex align-items-start justify-content-between mb-3">
                                                ...
                                                <span class="badge bg-primary-subtle text-primary border">Module {{ $loop->iteration }}</span>
                                            </div>
                                            <h6 class="card-title fw-semibold mb-3">{{ $module->module_name }}</h6>
                                            <div class="flex-grow-1 mb-4">
                                                <p class="card-text text-muted mb-3 lh-base">
                                                    {{ $module->module_description ?? 'No description available for this module. This module contains important course content and learning materials for students.' }}
                                                </p>
                                                <div class="row g-2 mb-3">
                                                    <div class="col-6">
                                                        <div class="bg-light rounded p-2 text-center">
                                                            <small class="text-muted d-block">Courses</small>
                                                            <strong class="text-primary">{{ $module->courses->count() ?? 0 }}</strong>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="bg-light rounded p-2 text-center">
                                            ...
                                            <div class="mt-auto">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <button class="btn btn-outline-primary btn-sm" 
                                                            ...
                                                            data-bs-target="#moduleModal{{ $module->modules_id }}">
            ...
            <div class="detail-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <h5 class="card-title d-flex align-items-center justify-content-between">
                        ...
                        <span class="badge bg-primary-subtle text-primary">{{ $program->students->count() }}</span>
                    </h5>
                </div>
                <div class="card-body">
                    @if($program->students->count() > 0)
                        <div class="student-list">
                            @foreach($program->students->take(8) as $student)
                                <div class="student-item d-flex align-items-center p-3 mb-3 bg-light bg-gradient rounded-3 border border-light shadow-sm">
                                    <div class="student-avatar-enhanced me-3">
                                        <div class="position-relative">
                                            @if($student->profile_photo && file_exists(public_path('storage/profile-photos/' . $student->profile_photo)))
                                                <img src="{{ asset('storage/profile-photos/' . $student->profile_photo) }}" 
                                                     alt="{{ $student->firstname }} {{ $student->lastname }}"
                                                     class="avatar-circle"
                                                     style="object-fit: cover; width: 45px; height: 45px; border-radius: 50%;">
                                            @elseif($student->profile_photo && file_exists(public_path('storage/' . $student->profile_photo)))
                                                <img src="{{ asset('storage/' . $student->profile_photo) }}" 
                                                     alt="{{ $student->firstname }} {{ $student->lastname }}"
                                                     class="avatar-circle"
                                                     style="object-fit: cover; width: 45px; height: 45px; border-radius: 50%;">
                                            @elseif($student->photo_2x2 && file_exists(public_path('storage/profile-photos/' . $student->photo_2x2)))
                                                <img src="{{ asset('storage/profile-photos/' . $student->photo_2x2) }}" 
                                                     alt="{{ $student->firstname }} {{ $student->lastname }}"
                                                     class="avatar-circle"
                                                     style="object-fit: cover; width: 45px; height: 45px; border-radius: 50%;">
                                            @elseif($student->photo_2x2 && file_exists(public_path('storage/' . $student->photo_2x2)))
                                                <img src="{{ asset('storage/' . $student->photo_2x2) }}" 
                                                     alt="{{ $student->firstname }} {{ $student->lastname }}"
                                                     class="avatar-circle"
                                                     style="object-fit: cover; width: 45px; height: 45px; border-radius: 50%;">
                                            @elseif($student->passport_photo && file_exists(public_path('storage/profile-photos/' . $student->passport_photo)))
                                                <img src="{{ asset('storage/profile-photos/' . $student->passport_photo) }}" 
                                                     alt="{{ $student->firstname }} {{ $student->lastname }}"
                                                     class="avatar-circle"
                                                     style="object-fit: cover; width: 45px; height: 45px; border-radius: 50%;">
                                            @elseif($student->passport_photo && file_exists(public_path('storage/' . $student->passport_photo)))
                                                <img src="{{ asset('storage/' . $student->passport_photo) }}" 
                                                     alt="{{ $student->firstname }} {{ $student->lastname }}"
                                                     class="avatar-circle"
                                                     style="object-fit: cover; width: 45px; height: 45px; border-radius: 50%;">
                                            @elseif($student->id_photo && file_exists(public_path('storage/profile-photos/' . $student->id_photo)))
                                                <img src="{{ asset('storage/profile-photos/' . $student->id_photo) }}" 
                                                     alt="{{ $student->firstname }} {{ $student->lastname }}"
                                                     class="avatar-circle"
                                                     style="object-fit: cover; width: 45px; height: 45px; border-radius: 50%;">
                                            @elseif($student->id_photo && file_exists(public_path('storage/' . $student->id_photo)))
                                    ...
                                    <div class="student-info flex-grow-1">
                                        <h6 class="student-name mb-1 fw-semibold">{{ $student->firstname }} {{ $student->lastname }}</h6>
...
function toggleAllStudents() {
    ...
    if (additionalDiv.style.display === 'none') {
        ...
        const hiddenCount = {{ $program->students->count() - 8 }};
...
@foreach($program->modules as $module)
<div class="modal fade" id="moduleModal{{ $module->modules_id }}" tabindex="-1" aria-labelledby="moduleModalLabel{{ $module->modules_id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header text-white" style="background: linear-gradient(135deg, #2563eb, #7c3aed);">
                <h5 class="modal-title" id="moduleModalLabel{{ $module->modules_id }}">
                    <i class="bi bi-book me-2"></i>{{ $module->module_name }}
                </h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-muted mt-1">{{ $module->module_description ?? 'No description available' }}</p>
                        </div>
                        <div class="mb-3">
                            <strong>Created:</strong>
                            <span class="text-muted">{{ $module->created_at->format('F d, Y') }}</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="bg-light rounded p-3">
                            ...
                            <div class="text-center">
                                <div class="mb-2">
                                    ...
                                    <div class="fw-bold">{{ $module->courses->count() }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if($module->courses && $module->courses->count() > 0)
                <hr>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <h6 class="card-title text-primary mb-0 fw-semibold">
                                        {{ $course->subject_name ?? 'Course ' . $loop->iteration }}
                                    </h6>
                                </div>
                                <p class="card-text small text-muted mb-3">
                                    {{ Str::limit($course->subject_description ?? 'This course contains important learning materials and content for students to study and complete.', 120) }}
                                </p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-muted">
                                        <i class="bi bi-calendar3 me-1"></i>
