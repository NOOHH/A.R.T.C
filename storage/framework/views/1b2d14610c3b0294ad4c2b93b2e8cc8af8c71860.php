...
<div class="main-content-wrapper">
    <div class="packages-container">
        ...
        <div class="analytics-grid">
            ...
            <div class="analytics-card">
                <h3><?php echo e($activeEnrollments ?? 0); ?></h3>
            ...
            <div class="analytics-card">
                <h3><?php echo e($popularityRate ?? 0); ?>%</h3>
            ...
            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="package-item" data-package-id="<?php echo e($package->package_id); ?>">
                    <div class="package-header">
                        <div class="package-badge"><?php echo e(ucfirst($package->package_type)); ?></div>
                    ...
                    <div class="package-content">
                        ...
                        <div class="package-details">
                            <div class="package-detail">
                                ...
                                <div class="package-detail-value"><?php echo e(ucfirst($package->package_type)); ?></div>
                            </div>
                            <div class="package-detail">
                            ...
                            <div class="package-detail">
                                ...
                                <div class="package-detail-value"><?php echo e($package->enrollments_count ?? 0); ?></div>
                            </div>
                            <div class="package-detail">
                                <div class="package-detail-label">
                                    ...
                                    ?>
                                    <span class="popularity-badge <?php echo e($popularityClass); ?>"><?php echo e($popularityText); ?></span>
                                </div>
                                <div class="package-detail-value"><?php echo e($popularity); ?>%</div>
                            </div>
                        </div>
                        
                        <div class="package-price">₱<?php echo e(number_format($package->price ?? 0, 2)); ?></div>
    ...
    <div class="modal-content">
        ...
        <form id="addPackageForm" method="POST" action="<?php echo e(route('admin.packages.store')); ?>">
            ...
            <div class="form-row">
                ...
                <div class="form-group" id="selectionTypeGroup" style="display: none;">
                    ...
                    <select id="selection_type" name="selection_type" onchange="handleSelectionTypeChange()">
                        ...
                        <option value="both">Both Module & Course</option>
                    </select>
                </div>
            ...
            <div class="course-selection" id="courseSelection" style="display: none;">
                <h4>Select Courses (Optional)</h4>
                <div class="module-count-info">
                    <small>Select specific courses for this package. Students will only access these courses.</small>
                </div>
                <div class="course-checkboxes" id="courseCheckboxes">
                    <!-- Courses will be loaded dynamically -->
                </div>
                <div class="selected-courses-display" id="selectedCoursesDisplay" style="display: none;">
                    <h4>Selected Courses: <span id="selectedCoursesCount">0</span></h4>
        ...
        <form id="editPackageForm" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group" id="editSelectionTypeGroup" style="display: none;">
                    <label for="edit_selection_type">Selection Type</label>
            ...
            <div class="course-selection" id="editCourseSelection" style="display: none;">
                <h4>Select Courses (Optional)</h4>
                <div class="module-count-info">
                    <small>Select specific courses for this package. Students will only access these courses.</small>
                </div>
                ...
                <div class="selected-courses-display" id="editSelectedCoursesDisplay" style="display: none;">
                    <h4>Selected Courses: <span id="editSelectedCoursesCount">0</span></h4>
...
function editPackage(packageId) {
    ...
    fetch(`/admin/packages/${packageId}`)
        ...
        .then(data => {
            ...
            document.getElementById('edit_selection_type').value = data.selection_type || 'module';
            ...
            // Load modules and courses for the selected program
            loadModulesForProgram(data.program_id, 'edit');
            loadCoursesForProgram(data.program_id, 'edit');
            
            // Pre-select existing modules and courses
            if (data.modules) {
                editSelectedModules = data.modules.map(m => ({ id: m.modules_id, name: m.module_name }));
            }
            if (data.courses) {
                editSelectedCourses = data.courses.map(c => ({ id: c.subject_id, name: c.subject_name }));
            }
        })
        .catch(error => {
...
function handlePackageTypeChange() {
    ...
    const selectionTypeGroup = document.getElementById('selectionTypeGroup');
...
function handleSelectionTypeChange() {
    ...
    if (selectionType === 'module') {
        ...
        loadCoursesForProgram(document.getElementById('program_id').value, 'add');
...
function handleEditPackageTypeChange() {
    ...
    const selectionTypeGroup = document.getElementById('editSelectionTypeGroup');
    ...
    const courseSelection = document.getElementById('editCourseSelection');
...
function handleEditSelectionTypeChange() {
    ...
    if (selectionType === 'module') {
        ...
        moduleSelection.style.display = 'none';
        courseSelection.style.display = 'block';
        loadCoursesForProgram(document.getElementById('edit_program_id').value, 'edit');
    } else if (selectionType === 'both') {
        moduleSelection.style.display = 'block';
        courseSelection.style.display = 'block';
        loadCoursesForProgram(document.getElementById('edit_program_id').value, 'edit');
            ...
            if (data.success) {
                ...
                container.innerHTML = data.modules.map(module => `
                    <div class="module-checkbox">
                        <input type="checkbox" id="${mode}_module_${module.modules_id}" value="${module.modules_id}" 
                               onchange="handleModuleSelection(this, '${mode}')">
                        <label for="${mode}_module_${module.modules_id}">${module.module_name}</label>
                    </div>
                `).join('');
            }
        })
            ...
            if (data.success) {
                ...
                data.modules.forEach(module => {
                    if (module.courses && module.courses.length > 0) {
                        coursesHtml += `<h5>${module.module_name}</h5>`;
                        module.courses.forEach(course => {
                            coursesHtml += `
                                <div class="course-checkbox">
                                    <input type="checkbox" id="${mode}_course_${course.subject_id}" value="${course.subject_id}" 
                                           onchange="handleCourseSelection(this, '${mode}')">
                                    <label for="${mode}_course_${course.subject_id}">${course.subject_name}</label>
                                </div>
                            `;
                        });
                    }
...
function handleCourseSelection(checkbox, mode) {
    ...
    if (mode === 'add') {
        if (checkbox.checked) {
            selectedCourses.push({ id: courseId, name: courseLabel });
        } else {
        ...
        if (checkbox.checked) {
            editSelectedCourses.push({ id: courseId, name: courseLabel });
        } else {
...
function updateSelectedCoursesDisplay() {
    ...
    list.innerHTML = selectedCourses.map(course => 
        `<span class="badge bg-info me-2">${course.name}</span>`
    ).join('');
...
document.getElementById('program_id').addEventListener('change', function() {
    ...
    if (selectionType === 'course' || selectionType === 'both') {
        loadCoursesForProgram(this.value, 'add');
    }
});
...
document.getElementById('edit_program_id').addEventListener('change', function() {
    ...
    const selectionType = document.getElementById('edit_selection_type').value;
    if (selectionType === 'course' || selectionType === 'both') {
        loadCoursesForProgram(this.value, 'edit');
    }
});
    ...
    <div class="packages-container">
        ...
        <div class="package-list">
            ...
            <div class="package-item">
                ...
                <div class="package-content">
                    <div class="package-description" title="<?php echo e($package->description); ?>">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        <button type="button" class="btn btn-success flex-fill fw-semibold edit-package-btn" 
                                data-id="<?php echo e($package->package_id); ?>" 
                                data-name="<?php echo e($package->package_name); ?>" 
                                data-description="<?php echo e($package->description); ?>" 
                                data-amount="<?php echo e($package->amount); ?>">
                            <i class="fas fa-edit me-1"></i>Edit
                        </button>
                        <form action="<?php echo e(route('admin.packages.delete', $package->package_id)); ?>" method="POST" class="flex-fill">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\admin-packages\admin-packages-backup.blade.php ENDPATH**/ ?>