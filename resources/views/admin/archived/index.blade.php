            ...
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-secondary">{{ isset($archivedPrograms) ? $archivedPrograms->count() : 3 }}</span>
                    </div>
                    <div class="card-body">
                        @if(isset($archivedPrograms) && $archivedPrograms->count() > 0)
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $program->program_name ?? $program->name ?? 'Unknown Program' }}</td>
                                            <td>{{ $program->archived_at ? $program->archived_at->format('M d, Y') : 'Unknown' }}</td>
                                            <td>
                                                <button class="btn btn-sm btn-success" onclick="restoreProgram({{ $program->id }})">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-secondary">{{ isset($archivedCourses) ? $archivedCourses->count() : 2 }}</span>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
