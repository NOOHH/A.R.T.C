...
<link rel="stylesheet" href="<?php echo e(asset('css/homepage/homepage.css')); ?>?v=<?php echo e(time()); ?>">
...
<?php echo App\Helpers\SettingsHelper::getHomepageCustomStyles(); ?>
...
<section class="modalities-section" style="background: linear-gradient(135deg, <?php echo e($modalitiesBgColor); ?> 0%, <?php echo e($gradientColor); ?> 100%);">
    ...
    <!-- About Section -->
<section class="about-section" style="background-color: <?php echo e($aboutBgColor); ?>; padding: 60px 0;">
    <div class="container">
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/welcome/homepage.blade.php ENDPATH**/ ?>