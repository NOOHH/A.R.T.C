...
<div class="upload-container">
    ...
    <form id="nonModalContentForm" action="<?php echo e(route('admin.modules.course-content-store')); ?>" method="POST" enctype="multipart/form-data" class="upload-form">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/admin/admin-modules/course-content-upload.blade.php ENDPATH**/ ?>