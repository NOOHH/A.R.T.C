...
@section('title', 'My Batches - Professor Dashboard')
            ...
            <div class="stats-overview">
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-number">{{ $batches->count() }}</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number">{{ $batches->sum(function($batch) { return $batch->students->count(); }) }}</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number">{{ $batches->unique('program_id')->count() }}</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number">{{ $batches->filter(function($batch) { return $batch->students->count() > 0; })->count() }}</div>
                            ...
                            <div class="batch-header-content">
                                <div class="batch-info">
                                    ...
                                    <div class="batch-meta">
                                        <div class="meta-item">
                                            <i class="bi bi-mortarboard"></i>
                                            <span><strong>Program:</strong> {{ $batch->program->program_name ?? 'Unknown Program' }}</span>
                                        </div>
                                        <div class="meta-item">
                                            <i class="bi bi-calendar-check"></i>
                                            <span><strong>Start:</strong> {{ $batch->start_date ? \Carbon\Carbon::parse($batch->start_date)->format('M d, Y') : 'Not set' }}</span>
                                        </div>
                                        <div class="meta-item">
                                            <i class="bi bi-calendar-x"></i>
                                            <span><strong>End:</strong> {{ $batch->end_date ? \Carbon\Carbon::parse($batch->end_date)->format('M d, Y') : 'Not set' }}</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="batch-body">
                            <div class="students-section">
                                <h3>
                                    <i class="bi bi-people"></i>
                                    Enrolled Students
                                    <span class="badge bg-primary ms-2">{{ $batch->students->count() }}</span>
                                </h3>
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach($batch->students as $student)
                                                    <tr>
                                                        <td>
                                                            <div class="student-name">{{ $student->student_firstname }} {{ $student->student_lastname }}</div>
                                                        </td>
                                                        <td>
