...
<body>
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ul class="navbar-nav flex-row">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.clients.index')); ?>" class="nav-link active">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            ...
                            <?php echo e(Auth::guard('smartprep')->user()->name); ?>

                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('smartprep.logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    ...
    <!-- Logout Form -->
    <form id="logout-form" action="<?php echo e(route('smartprep.logout')); ?>" method="POST" class="d-none">
        <?php echo csrf_field(); ?>
    </form>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(route('admin.clients.index')); ?>" class="btn btn-outline-primary">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="slug" value="<?php echo e(old('slug', $client->slug)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="domain" name="domain" value="<?php echo e(old('domain', $client->domain)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="db_name" name="db_name" value="<?php echo e(old('db_name', $client->db_name)); ?>">
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\smartprep\admin\clients\edit.blade.php ENDPATH**/ ?>