...
<div class="col-lg-6">
    ...
    <form method="POST" action="<?php echo e(route('smartprep.login.submit')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="<?php echo e($f->field_key); ?>" 
                        ...
                        <?php echo e($f->is_required ? 'required' : ''); ?> autocomplete="<?php echo e($autocomplete); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="auth-links">
            <p class="text-muted mb-3">Don't have an account? <a href="<?php echo e(route('smartprep.register')); ?>">Create one here</a></p>
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('smartprep.password.request')); ?>">Forgot your password?</a>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/smartprep/auth/login.blade.php ENDPATH**/ ?>