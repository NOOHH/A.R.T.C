        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('smartprep.admin.clients')); ?>">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 d-flex justify-content-md-end mt-4 mt-md-0">
                    <a href="<?php echo e(route('smartprep.admin.clients.create')); ?>" class="btn btn-light btn-lg">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="stats-card">
                    ...
                    <div class="stats-number"><?php echo e($clients->count()); ?></div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="stats-card">
                    ...
                    <div class="stats-number"><?php echo e($archivedClients->count()); ?></div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="stats-card">
                    ...
                    <div class="stats-number"><?php echo e($clients->count() + $archivedClients->count()); ?></div>
                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-tabs client-tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="active-tab" data-bs-toggle="tab" data-bs-target="#active" type="button" role="tab">
                                    ...
                                    <span class="badge bg-primary ms-2"><?php echo e($clients->count()); ?></span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="archived-tab" data-bs-toggle="tab" data-bs-target="#archived" type="button" role="tab">
                                    ...
                                    <span class="badge bg-secondary ms-2"><?php echo e($archivedClients->count()); ?></span>
                                </button>
                            </li>
                        </ul>
                                        ...
                                        <tr class="table-row">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <?php if(isset($client->external_url)): ?>
                                                        <span class="badge badge-secondary">External</span>
                                                    <?php endif; ?>
                                                    <code class="code-badge"><?php echo e($client->slug); ?></code>
                                                </div>
                                            </td>
                                            <td><code class="code-badge"><?php echo e($client->db_name); ?></code></td>
                                            <td>
                                                <span class="date-text"><?php echo e(optional($client->created_at)->format('M j, Y') ?? '—'); ?></span>
                                            </td>
                                            <td>
                                                <div class="btn-group action-buttons" role="group">
                                                    <a href="<?php echo e(isset($client->external_url) ? $client->external_url : '/t/'.$client->slug); ?>" 
                                                       class="btn btn-outline-primary btn-sm" target="_blank" title="Visit Website">
                                                        <i class="fas fa-external-link-alt"></i>
                                                    </a>
                                                    <a href="<?php echo e(isset($client->external_url) ? $client->external_url : '/t/'.$client->slug); ?>/admin/dashboard" 
                                                       class="btn btn-primary btn-sm" target="_blank" title="Admin Panel">
                                                        <i class="fas fa-cog"></i>
                                                    </a>
                                                    
                                                    <?php if(!isset($client->external_url)): ?>
                                                        <a href="<?php echo e(route('smartprep.admin.clients.edit', $client->id)); ?>" 
                                                        ...
                                                        <button type="button" class="btn btn-outline-warning btn-sm" 
                                                                ...
                                                                onclick="confirmArchive('<?php echo e($client->name); ?>', '<?php echo e($client->id); ?>')">
                                                            <i class="fas fa-archive"></i>
                                                        </button>
                                                        

                                                        
                                                        <form id="archive-form-<?php echo e($client->id); ?>" 
                                                              action="<?php echo e(route('smartprep.admin.clients.archive', $client->id)); ?>" 
                        ...
                        <?php endif; ?>
                            ...
                            <div class="tab-pane fade" id="archived" role="tabpanel" aria-labelledby="archived-tab">
                                <?php if($archivedClients->count() > 0): ?>
                                <div class="table-responsive">
                                    <div class="client-table-header">
                                    ...
                                    <table class="table table-modern">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $archivedClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <td>
                                                    <div class="btn-group action-buttons" role="group">
                                                        <button type="button" class="btn btn-outline-success btn-sm" 
                                                                ...
                                                                onclick="confirmRestore('<?php echo e($client->name); ?>', '<?php echo e($client->id); ?>')">
                                                            <i class="fas fa-trash-restore"></i>
                                                        </button>
                                                        
                                                        <button type="button" class="btn btn-outline-danger btn-sm" 
                                                                title="Delete Permanently" 
                                                                onclick="confirmDelete('<?php echo e($client->name); ?>', '<?php echo e($client->id); ?>')">
                                                            <i class="fas fa-trash"></i>
                                                        </button>
                                                        
                                                        <form id="restore-form-<?php echo e($client->id); ?>" 
                                                              action="<?php echo e(route('smartprep.admin.clients.unarchive', $client->id)); ?>" 
                                                              method="POST" style="display: none;">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('PATCH'); ?>
                                                        </form>
                                                        ...
                                                        <form id="delete-form-<?php echo e($client->id); ?>" 
                                                              action="<?php echo e(route('smartprep.admin.clients.destroy', $client->id)); ?>" 
                                                              method="POST" style="display: none;">
                                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/smartprep/admin/clients/index.blade.php ENDPATH**/ ?>