...
@section('title', $profile['name'] . ' - Student Profile')
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-8">
            ...
            <div class="profile-badges">
                ...
                <span class="profile-badge {{ $profile['status'] === 'Online' ? 'success' : 'secondary' }}">
                    ...
                    @foreach($profile['enrollments'] as $enrollment)
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="enrollment-item">
                                ...
                                <div class="mt-2">
                                    <a href="{{ route('professor.professor.view.program', $enrollment['program_id']) }}" 
        ...
        <div class="info-card">
            ...
            <div class="card-body">
                <div class="info-item">
                    ...
                    <span class="info-value">{{ $profile['created_at']->format('M d, Y') }}</span>
                </div>
                @if($profile['last_seen'])
                    <div class="info-item">
                        <span class="info-label">Last Activity:</span>
                        <span class="info-value">{{ $profile['last_seen']->diffForHumans() }}</span>
                    </div>
                @endif
                <div class="info-item">
