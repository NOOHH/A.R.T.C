...
<div class="col-lg-6">
    <div class="auth-right">
        ...
        <div class="auth-links">
            <p class="text-muted mb-0">Need help? <a href="<?php echo e(route('login')); ?>">Back to login</a></p>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\auth\verify.blade.php ENDPATH**/ ?>