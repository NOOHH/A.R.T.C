            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="color-input-group">
                        <input type="color" id="student_sidebar_primary_color" class="form-control form-control-color" value="{{ $settings['student_sidebar']['primary_color'] ?? '#3f4d69' }}" onchange="updateColorText('student_sidebar_primary_color', this.value)">
                        <input type="text" class="form-control form-control-sm" value="{{ $settings['student_sidebar']['primary_color'] ?? '#3f4d69' }}" onchange="updateColorPicker('student_sidebar_primary_color', this.value)">
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Secondary Color</label>
                    <div class="color-input-group">
                        <input type="color" id="student_sidebar_secondary_color" class="form-control form-control-color" value="{{ $settings['student_sidebar']['secondary_color'] ?? '#2d2d2d' }}" onchange="updateColorText('student_sidebar_secondary_color', this.value)">
                        <input type="text" class="form-control form-control-sm" value="{{ $settings['student_sidebar']['secondary_color'] ?? '#2d2d2d' }}" onchange="updateColorPicker('student_sidebar_secondary_color', this.value)">
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Accent Color</label>
                    <div class="color-input-group">
                        <input type="color" id="student_sidebar_accent_color" class="form-control form-control-color" value="{{ $settings['student_sidebar']['accent_color'] ?? '#4f757d' }}" onchange="updateColorText('student_sidebar_accent_color', this.value)">
                        <input type="text" class="form-control form-control-sm" value="{{ $settings['student_sidebar']['accent_color'] ?? '#4f757d' }}" onchange="updateColorPicker('student_sidebar_accent_color', this.value)">
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Text Color</label>
                    <div class="color-input-group">
                        <input type="color" id="student_sidebar_text_color" class="form-control form-control-color" value="{{ $settings['student_sidebar']['text_color'] ?? '#e0e0e0' }}" onchange="updateColorText('student_sidebar_text_color', this.value)">
                        <input type="text" class="form-control form-control-sm" value="{{ $settings['student_sidebar']['text_color'] ?? '#e0e0e0' }}" onchange="updateColorPicker('student_sidebar_text_color', this.value)">
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Hover Color</label>
                    <div class="color-input-group">
                        <input type="color" id="student_sidebar_hover_color" class="form-control form-control-color" value="{{ $settings['student_sidebar']['hover_color'] ?? '#374151' }}" onchange="updateColorText('student_sidebar_hover_color', this.value)">
                        <input type="text" class="form-control form-control-sm" value="{{ $settings['student_sidebar']['hover_color'] ?? '#374151' }}" onchange="updateColorPicker('student_sidebar_hover_color', this.value)">
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Sidebar Width</label>
                    <input type="number" id="student_sidebar_width" class="form-control" placeholder="280" min="200" max="400" value="{{ $settings['student_sidebar']['width'] ?? '280' }}">
                    <small class="form-text text-muted">Width in pixels (200-400px)</small>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Collapsed Width</label>
                    <input type="number" id="student_sidebar_collapsed_width" class="form-control" placeholder="70" min="50" max="100" value="{{ $settings['student_sidebar']['collapsed_width'] ?? '70' }}">
