...
} elseif ($_instance->childHasBeenRendered('C84D1fo')) {
    $componentId = $_instance->getRenderedChildComponentId('C84D1fo');
    $componentTag = $_instance->getRenderedChildComponentTagName('C84D1fo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C84D1fo');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('C84D1fo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\A.R.T.C\vendor\filament\filament\resources\views\components\layouts\card.blade.php ENDPATH**/ ?>