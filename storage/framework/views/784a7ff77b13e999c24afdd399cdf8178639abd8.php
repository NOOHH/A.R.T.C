    ...
    <header class="main-header">
        <div class="header-left">
            ...
            <div class="brand-container d-flex align-items-center gap-3" style="height:68px;">
                ...
                <?php else: ?>
                    <img src="<?php echo e($defaultLogo); ?>" alt="<?php echo e($brandName); ?>" class="brand-logo" style="height:56px; width:auto; border-radius:8px; box-shadow:0 2px 8px rgba(0,0,0,0.08); background:#fff;">
                <?php endif; ?>
                <div class="brand-text-area d-flex flex-column justify-content-center">
                    <span class="brand-text fw-bold" style="font-size:1.25rem; color:#764ba2; letter-spacing:1px;"><?php echo e($brandName); ?></span>
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\professor\layout.blade.php ENDPATH**/ ?>