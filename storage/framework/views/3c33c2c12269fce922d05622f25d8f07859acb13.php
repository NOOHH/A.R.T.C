        ...
        <form action="<?php echo e(route('student.settings.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="user_firstname" 
                               name="user_firstname" 
                               value="<?php echo e(old('user_firstname', $user->user_firstname ?? $student->firstname ?? '')); ?>" 
                               required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="middlename" 
                               name="middlename" 
                               value="<?php echo e(old('middlename', $student->middlename ?? '')); ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="user_lastname" 
                               name="user_lastname" 
                               value="<?php echo e(old('user_lastname', $user->user_lastname ?? $student->lastname ?? '')); ?>" 
                               required>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="email-field-wrapper">
                            <input type="email" 
                                   ...
                                   id="user_email" 
                                   name="user_email" 
                                   value="<?php echo e(old('user_email', $user->email ?? $student->email ?? '')); ?>" 
                                   readonly>
            ...
            <div class="form-group">
                ...
                <div class="profile-upload-container">
                    <div class="profile-photo-display">
                        <?php if(isset($student->profile_photo) && $student->profile_photo): ?>
                            <img id="profilePreview" src="<?php echo e(asset('storage/profile-photos/' . $student->profile_photo)); ?>" alt="Profile Photo" class="profile-image">
                        <?php else: ?>
                    ...
                    <div class="profile-upload-info">
                        ...
                        <?php if(isset($student->profile_photo) && $student->profile_photo): ?>
                            <div class="current-photo-actions mt-2">
                                <button type="button" class="btn-view" onclick="viewProfilePhoto('<?php echo e($student->profile_photo); ?>')">
            ...
            <?php if(isset($formRequirements) && $formRequirements->count() > 0): ?>
                <?php $__currentLoopData = $formRequirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requirement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(!$shouldSkip): ?>
                        <div class="form-group">
                            <label for="<?php echo e($requirement->field_name); ?>">
                                <?php echo e($requirement->field_label); ?>

                                <?php if($requirement->is_required): ?> * <?php endif; ?>
                            </label>
                            
                            <?php if($requirement->field_type == 'text'): ?>
                                <input type="text" 
                                       class="form-control" 
                                       id="<?php echo e($requirement->field_name); ?>" 
                                       name="<?php echo e($requirement->field_name); ?>" 
                                       value="<?php echo e(old($requirement->field_name, $student->{$requirement->field_name} ?? '')); ?>"
                                       <?php if($requirement->is_required): ?> required <?php endif; ?>>
                            
                            <?php elseif($requirement->field_type == 'email'): ?>
                                <input type="email" 
                                       class="form-control" 
                                       id="<?php echo e($requirement->field_name); ?>" 
                                       name="<?php echo e($requirement->field_name); ?>" 
                            ...
                            <?php elseif($requirement->field_type == 'file'): ?>
                                <div class="file-upload-section">
                                    <input type="file" 
                                           ...
                                           <?php if($requirement->is_required && !isset($student->{$requirement->field_name})): ?> required <?php endif; ?>>
                                    
                                    <?php if(isset($student->{$requirement->field_name}) && $student->{$requirement->field_name}): ?>
                                        <div class="file-preview">
                                            <small class="text-success">✓ File uploaded</small>
                                            <a href="#" onclick="viewFile('<?php echo e($requirement->field_name); ?>', '<?php echo e($student->{$requirement->field_name}); ?>')">
                            ...
                            <?php elseif($requirement->field_type == 'select'): ?>
                                <select class="form-control" 
                                        ...
                                        name="<?php echo e($requirement->field_name); ?>"
                                        <?php if($requirement->is_required): ?> required <?php endif; ?>>
                                    <option value="">Select <?php echo e($requirement->field_label); ?></option>
                                    <?php if($requirement->field_options): ?>
                                        <?php $__currentLoopData = $requirement->field_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($option); ?>" 
                                                    <?php echo e(old($requirement->field_name, $student->{$requirement->field_name} ?? '') == $option ? 'selected' : ''); ?>>
                                                <?php echo e($option); ?>
            ...
            <div class="form-group full-width">
                ...
                <input type="text" 
                       ...
                       id="street_address" 
                       name="street_address" 
                       value="<?php echo e(old('street_address', $student->street_address ?? '')); ?>">
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="state_province" 
                               name="state_province" 
                               value="<?php echo e(old('state_province', $student->state_province ?? '')); ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="zipcode" 
                               name="zipcode" 
                               value="<?php echo e(old('zipcode', $student->zipcode ?? '')); ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="student_id" 
                               value="<?php echo e($student->student_id ?? 'Not applicable'); ?>" 
                               readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               class="form-control readonly" 
                               id="program_name" 
                               value="<?php echo e($student->program_name ?? 'Not enrolled yet'); ?>" 
                               readonly>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="changePasswordModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="changePasswordForm" action="<?php echo e(route('student.change-password')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
...
<div class="modal fade" id="resetPasswordModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="resetPasswordForm" action="<?php echo e(route('student.reset-password')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email_confirm" name="email" value="<?php echo e($student->email ?? ''); ?>" readonly>
                    </div>
...
function sendEmailOTP() {
    ...
    // Send OTP request
    fetch('<?php echo e(route("student.send-otp")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('student.student-dashboard.student-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/student/student-settings/settings.blade.php ENDPATH**/ ?>