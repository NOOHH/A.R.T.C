            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if(auth()->guard('smartprep')->check()): ?>
                        <li class="nav-item">
                            <a class="btn btn-hero" href="<?php echo e(route('smartprep.dashboard')); ?>">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero-content fade-in-up">
                        ...
                        <div>
                            <?php if(auth()->guard('smartprep')->check()): ?>
                                <a href="<?php echo e(route('smartprep.dashboard')); ?>" class="btn btn-hero me-3">
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="cta-card">
                        ...
                        <?php if(auth()->guard('smartprep')->check()): ?>
                            <a href="<?php echo e(route('smartprep.dashboard')); ?>" class="btn btn-light btn-lg">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <?php if(auth()->guard('smartprep')->check()): ?>
                            <li class="mb-2"><a href="<?php echo e(route('smartprep.dashboard')); ?>" class="text-light text-decoration-none">Dashboard</a></li>
                        <?php else: ?>
