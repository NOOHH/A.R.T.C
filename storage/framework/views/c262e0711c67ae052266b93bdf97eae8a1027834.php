...
<div class="modules-container">
    <div class="d-flex justify-content-between align-items-center mb-4 px-2">
        ...
        <div class="d-flex gap-3 align-items-center">
            <a href="<?php echo e(route('admin.modules.index')); ?>" class="btn btn-lg text-white fw-semibold px-4 py-2 rounded-pill shadow back-to-modules-btn">
    ...
    <!-- Batch Actions -->
    <?php if(request('program_id') && isset($archivedModules) && $archivedModules->count() > 0): ?>
    ...
    <div id="modulesDisplayArea">
        <?php if(request('program_id') && isset($archivedModules)): ?>
                        ...
                        <div class="module-card">
                            ...
                            <div class="d-flex align-items-start gap-3">
                                <input type="checkbox" 
                                       ...
                                       data-module-id="<?php echo e($module->modules_id); ?>"
                                       onchange="toggleModuleSelection(<?php echo e($module->modules_id); ?>, this)">
                                <div class="flex-grow-1">
                                    <div class="module-title">
                                        <?php echo e($module->content_type_icon ?? '📚'); ?> <?php echo e($module->module_name); ?>

                                        <span class="content-type-badge <?php echo e($module->content_type ?? 'module'); ?>">
                                            <?php echo e($module->content_type_display ?? 'Module'); ?>

                                        </span>
                                    </div>
                                    
                                    <div class="module-description">
                                        <?php echo e($module->module_description); ?>

                                    </div>

                                    <?php if($module->content_data): ?>
                                        <div class="content-details">
                                            <?php $data = $module->content_data ?>
                                            <?php switch($module->content_type):
                                                case ('assignment'): ?>
                                                    <?php if(!empty($data['assignment_title'])): ?>
                                                        <strong>Title:</strong> <?php echo e($data['assignment_title']); ?><br>
                                                    <?php endif; ?>
                                                    <?php if(!empty($data['due_date'])): ?>
                                                        <strong>Due:</strong> <?php echo e(\Carbon\Carbon::parse($data['due_date'])->format('M d, Y g:i A')); ?><br>
                                                    <?php endif; ?>
                                                    <?php if(!empty($data['max_points'])): ?>
                                                        <strong>Points:</strong> <?php echo e($data['max_points']); ?>

                                                    <?php endif; ?>
                                                    <?php break; ?>
                                                <?php case ('quiz'): ?>
                                                    <?php if(!empty($data['quiz_title'])): ?>
                                                        <strong>Title:</strong> <?php echo e($data['quiz_title']); ?><br>
                                                    <?php endif; ?>
                                                    <?php if(!empty($data['time_limit'])): ?>
                                                        <strong>Time:</strong> <?php echo e($data['time_limit']); ?> minutes<br>
                                                    <?php endif; ?>
                                                    <?php if(!empty($data['question_count'])): ?>
                                                        <strong>Questions:</strong> <?php echo e($data['question_count']); ?>

                                                    <?php endif; ?>
                                                    <?php break; ?>
                                                <?php case ('test'): ?>
                                                    <?php if(!empty($data['test_title'])): ?>
                                                        <strong>Title:</strong> <?php echo e($data['test_title']); ?><br>
                                                    <?php endif; ?>
                                                    <?php if(!empty($data['test_date'])): ?>
                                                        <strong>Date:</strong> <?php echo e(\Carbon\Carbon::parse($data['test_date'])->format('M d, Y g:i A')); ?><br>
                                                    <?php endif; ?>
                                                    <?php if(!empty($data['total_marks'])): ?>
                                                        <strong>Total Marks:</strong> <?php echo e($data['total_marks']); ?>

                                                    <?php endif; ?>
                                                    <?php break; ?>
                                                <?php case ('link'): ?>
                                                    <?php if(!empty($data['link_title'])): ?>
                                                        <strong>Link:</strong> <?php echo e($data['link_title']); ?><br>
                                                    <?php endif; ?>
                                                    <?php if(!empty($data['external_url'])): ?>
                                                        <a href="<?php echo e($data['external_url']); ?>" target="_blank" class="download-link">
                                                            🔗 Open Link
                                                        </a>
                                                    <?php endif; ?>
                                                    <?php break; ?>
                                    ...
                                    <?php if($module->attachment): ?>
                                        <p><a href="<?php echo e(asset('storage/'.$module->attachment)); ?>" target="_blank" class="download-link">
                                            📎 Download file
                                        </a></p>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="module-meta">
                                <span class="module-program">
                                    <?php echo e($module->program->program_name); ?>

                                </span>
                                <div class="d-flex gap-2 flex-wrap">
                                    <button class="btn btn-success btn-sm fw-semibold" 
                                            onclick="toggleArchiveModule(<?php echo e($module->modules_id); ?>, true)">
                                        <i class="fas fa-folder-open me-1"></i>Unarchive
                                    </button>
                                    <button class="btn btn-warning btn-sm fw-semibold" 
                                            onclick="showOverrideModal(<?php echo e($module->modules_id); ?>, '<?php echo e(addslashes($module->module_name)); ?>')">
                                        <i class="fas fa-unlock me-1"></i>Override
                                    </button>
                                    <form action="<?php echo e(route('admin.modules.destroy', $module->modules_id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to permanently delete this module?')">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="text-center py-5">
                    <div class="bg-light border border-2 border-dashed rounded-4 p-5">
                        ...
                        <small class="text-muted">
                            <a href="<?php echo e(route('admin.modules.index')); ?>" class="text-primary text-decoration-none">
    ...
    if (programSelect) {
        programSelect.addEventListener('change', function() {
            ...
            window.location.href = pid
                ? `<?php echo e(route('admin.modules.archived')); ?>?program_id=${pid}`
                : `<?php echo e(route('admin.modules.archived')); ?>`;
        });
    }
});
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\admin-modules\admin-modules-archived-backup.blade.php ENDPATH**/ ?>