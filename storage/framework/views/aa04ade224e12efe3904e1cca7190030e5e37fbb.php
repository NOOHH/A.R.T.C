...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('professor.announcements.index')); ?>" class="btn btn-secondary">
    ...
    <form action="<?php echo e(route('professor.announcements.update', $announcement)); ?>" method="POST" id="announcementForm">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="target_scope" id="scope_all" 
                                       value="all" <?php echo e(old('target_scope', $targetScope) === 'all' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="target_scope" id="scope_specific" 
                                       value="specific" <?php echo e(old('target_scope', $targetScope) === 'specific' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="checkbox-item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="target_users[]" 
                                                   ...
                                                   <?php echo e(in_array('students', old('target_users', $announcement->target_users ?? ['students'])) ? 'checked' : ''); ?>>
                                            ...
                                            <div class="checkbox-item">
                                                <div class="form-check">
                                                    <input class="form-check-input program-checkbox" type="checkbox" name="target_programs[]" 
                                                           ...
                                                           <?php echo e(in_array($program->program_id, old('target_programs', $announcement->target_programs ?? [])) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="checkbox-item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="target_plans[]" 
                                                   ...
                                                   <?php echo e(in_array('full', old('target_plans', $announcement->target_plans ?? [])) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="checkbox-item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="target_plans[]" 
                                                   ...
                                                   <?php echo e(in_array('modular', old('target_plans', $announcement->target_plans ?? [])) ? 'checked' : ''); ?>>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_published" id="is_published" 
                                   value="1" <?php echo e(old('is_published', $announcement->is_published) ? 'checked' : ''); ?>>
                    ...
                    <div class="card-body">
                        <div class="announcement-preview" id="announcementPreview">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <span class="badge type-badge announcement-type-<?php echo e($announcement->type); ?>" id="previewType"><?php echo e(ucfirst($announcement->type)); ?></span>
                            </div>
                            <p class="text-muted mb-2" id="previewDescription"><?php echo e($announcement->description ?: 'Description will appear here...'); ?></p>
                            <div id="previewContent"><?php echo e($announcement->content); ?></div>
                            <hr>
                            <small class="text-muted">
                                <i class="bi bi-clock me-1"></i>
                                <span id="previewDate"><?php echo e($announcement->created_at->format('M d, Y g:i A')); ?></span>
                            </small>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const allBatches = <?php echo json_encode($batches); ?>;
    ...
    function updateBatchesDisplay() {
        ...
        Object.keys(batchesByProgram).forEach(programId => {
            const program = <?php echo json_encode($programs); ?>.find(p => p.program_id == programId);
            ...
            batches.forEach(batch => {
                const existingBatches = <?php echo json_encode(old('target_batches', $announcement->target_batches ?? [])); ?>;
...
<?php echo $__env->make('professor.professor-layouts.professor-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\professor\announcements\edit.blade.php ENDPATH**/ ?>