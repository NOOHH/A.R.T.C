...
<div class="sidebar-section" id="auth-settings" style="display: none;">
    ...
    <form id="loginForm" method="POST" action="{{ route('smartprep.dashboard.settings.update.auth', ['website' => $selectedWebsite->id]) }}" enctype="multipart/form-data" onsubmit="updateAuth(event)">
        @csrf
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="color" class="form-control form-control-color" name="login_accent_color" value="{{ $settings['auth']['login_accent_color'] ?? '#007bff' }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="color" class="form-control form-control-color" name="login_text_color" value="{{ $settings['auth']['login_text_color'] ?? '#495057' }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="color" class="form-control form-control-color" name="login_card_bg" value="{{ $settings['auth']['login_card_bg'] ?? '#ffffff' }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="color" class="form-control form-control-color" name="login_input_border" value="{{ $settings['auth']['login_input_border'] ?? '#ced4da' }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="color" class="form-control form-control-color" name="login_input_focus" value="{{ $settings['auth']['login_input_focus'] ?? '#80bdff' }}">
                </div>
    ...
    <form id="registrationForm" method="POST" action="{{ route('smartprep.dashboard.settings.update.registration', ['website' => $selectedWebsite->id]) }}" enctype="multipart/form-data" onsubmit="updateRegistration(event)">
        @csrf
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="system_fields[education_level][active]" {{ ($settings['auth']['system_fields']['education_level']['active'] ?? true) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="system_fields[education_level][required]" {{ ($settings['auth']['system_fields']['education_level']['required'] ?? true) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td><span class="badge bg-info">Both</span></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="system_fields[program_id][active]" {{ ($settings['auth']['system_fields']['program_id']['active'] ?? true) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="system_fields[program_id][required]" {{ ($settings['auth']['system_fields']['program_id']['required'] ?? true) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td><span class="badge bg-info">Both</span></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="system_fields[start_date][active]" {{ ($settings['auth']['system_fields']['start_date']['active'] ?? true) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="system_fields[start_date][required]" {{ ($settings['auth']['system_fields']['start_date']['required'] ?? true) ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td><span class="badge bg-info">Both</span></td>
                            </tr>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="custom_section_name" value="{{ $settings['auth']['custom_section_name'] ?? 'Personal Information' }}" placeholder="Personal Information">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label">Display Label</label>
                            <input type="text" class="form-control" name="custom_field_label" value="{{ $settings['auth']['custom_field_label'] ?? 'Birthday' }}" placeholder="Birthday">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" name="custom_field_type">
                                <option value="text" {{ ($settings['auth']['custom_field_type'] ?? 'text') == 'text' ? 'selected' : '' }}>Text</option>
                                <option value="email" {{ ($settings['auth']['custom_field_type'] ?? '') == 'email' ? 'selected' : '' }}>Email</option>
                                <option value="date" {{ ($settings['auth']['custom_field_type'] ?? '') == 'date' ? 'selected' : '' }}>Date</option>
                                <option value="select" {{ ($settings['auth']['custom_field_type'] ?? '') == 'select' ? 'selected' : '' }}>Select</option>
                                <option value="textarea" {{ ($settings['auth']['custom_field_type'] ?? '') == 'textarea' ? 'selected' : '' }}>Textarea</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" name="custom_field_program">
                                <option value="both" {{ ($settings['auth']['custom_field_program'] ?? 'both') == 'both' ? 'selected' : '' }}>Both</option>
                                <option value="complete" {{ ($settings['auth']['custom_field_program'] ?? '') == 'complete' ? 'selected' : '' }}>Complete Plan</option>
                                <option value="modular" {{ ($settings['auth']['custom_field_program'] ?? '') == 'modular' ? 'selected' : '' }}>Modular Plan</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <div class="d-flex gap-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="custom_field_required" id="customFieldRequired" {{ ($settings['auth']['custom_field_required'] ?? false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="customFieldRequired">Required</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="custom_field_active" id="customFieldActive" {{ ($settings['auth']['custom_field_active'] ?? true) ? 'checked' : '' }}>
