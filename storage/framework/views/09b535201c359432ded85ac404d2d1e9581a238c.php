...
<?php $__env->startSection('title', 'Course Content Upload'); ?>
...
<div class="upload-container">
    ...
    <form id="nonModalContentForm" action="<?php echo e(route('professor.modules.course-content-store')); ?>" method="POST" enctype="multipart/form-data" class="upload-form">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('professor.professor-layouts.professor-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\professor\modules\course-content-upload.blade.php ENDPATH**/ ?>