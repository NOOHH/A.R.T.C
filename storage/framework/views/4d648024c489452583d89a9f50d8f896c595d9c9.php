        ...
        <div class="deadlines-content">
            <?php $__empty_1 = true; $__currentLoopData = $deadlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deadline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card mb-3 deadline-item-modern shadow-sm border-0" 
                     onclick="redirectToAssignment('<?php echo e($deadline->reference_id); ?>', '<?php echo e($deadline->module_id); ?>', '<?php echo e($deadline->type); ?>', '<?php echo e($deadline->program_id ?? ''); ?>')"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start justify-content-between mb-3">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="card-title mb-1 fw-bold"><?php echo e($deadline->title); ?></h5>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <span class="badge <?php echo e($deadline->type === 'assignment' ? 'bg-primary' : 'bg-success'); ?> rounded-pill">
                                <?php echo e(ucfirst($deadline->type)); ?>
...
<?php echo $__env->make('layouts.tenant-student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\tenant\student\dashboard.blade.php ENDPATH**/ ?>