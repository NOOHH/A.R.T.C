        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('admin.website-requests')); ?>">
                                                ...
                                                <div class="btn-group action-buttons" role="group">
                                                    ...
                                                    <?php if(!isset($client->external_url)): ?>
                                                        ...
                                                        <form id="archive-form-<?php echo e($client->id); ?>" 
                                                              action="<?php echo e(route('admin.clients.archive', $client->id)); ?>" 
                                                ...
                                                <td>
                                                    <div class="btn-group action-buttons" role="group">
                                                        ...
                                                        <form id="restore-form-<?php echo e($client->id); ?>" 
                                                              action="<?php echo e(route('admin.clients.unarchive', $client->id)); ?>" 
                                                              method="POST" style="display: none;">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('PATCH'); ?>
                                                        </form>
                                                        ...
                                                        <form id="delete-form-<?php echo e($client->id); ?>" 
                                                              action="<?php echo e(route('admin.clients.destroy', $client->id)); ?>" 
                                                              method="POST" style="display: none;">
                                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\clients\index.blade.php ENDPATH**/ ?>