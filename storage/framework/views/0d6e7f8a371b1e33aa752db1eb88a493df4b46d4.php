...
function selectFAQ(type) {
    ...
    const faqResponses = {
        ...
        support: "Contact support via live chat, email (<?php echo e($navbar['contact_email'] ?? 'support@example.edu'); ?>), phone (+1-555-123-4567), or submit a ticket through the support portal."
    };
    const chatMessages = document.getElementById('chatMessages');
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/components/global-chat.blade.php ENDPATH**/ ?>