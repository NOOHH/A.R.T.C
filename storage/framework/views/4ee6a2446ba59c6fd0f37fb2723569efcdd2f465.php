                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select" id="monthFilter">
                        ...
                        <?php for($month = 1; $month <= 12; $month++): ?>
                            <option value="<?php echo e($month); ?>"><?php echo e(date('F', mktime(0, 0, 0, $month, 1))); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-12">
                    <div class="card border border-info shadow-sm">
                        <div class="card-body d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <div class="btn-group ms-auto">
                                <a href="<?php echo e(route('admin.board-passers.index')); ?>" class="btn btn-info" title="Manage Board Exam Passers">
        ...
        <div class="col-xl-6">
            <div class="card shadow-sm h-100">
                <div class="card-header d-flex justify-content-between align-items-center bg-light">
                    ...
                    <a href="<?php echo e(route('admin.board-passers.index')); ?>" class="btn btn-sm btn-outline-primary">
...
<script src="<?php echo e(asset('js/admin-analytics.js')); ?>"></script>
<script>
// Global variables
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Session data:', {
        user_type: '<?php echo e(session("user_type")); ?>',
        user_name: '<?php echo e(session("user_name")); ?>'
    });
...
function exportData(format) {
    ...
    var isAdmin = <?php echo e(isset($isAdmin) && $isAdmin ? 'true' : 'false'); ?>;
    if (!isAdmin) {
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\admin-analytics\admin-analytics.blade.php ENDPATH**/ ?>