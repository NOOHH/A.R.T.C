    ...
    <div class="row">
        <div class="col-md-4">
            <div class="text-center">
                ...
                <h5 class="fw-bold">{{ $student->user_firstname }} {{ $student->user_lastname }}</h5>
                <p class="text-muted">{{ $student->email }}</p>
                <span class="badge bg-info">{{ $student->registration->enrollment_type ?? 'N/A' }}</span>
            </div>
        </div>
        <div class="col-md-8">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <p class="mb-2">{{ $student->user_id }}</p>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Registration Date</label>
                    <p class="mb-2">{{ $student->created_at->format('M d, Y') }}</p>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Phone</label>
                    <p class="mb-2">{{ $student->registration->contact_number ?? 'N/A' }}</p>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Address</label>
                    <p class="mb-2">{{ $student->registration->street_address ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="metrics-list">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="text-success fw-bold">{{ rand(60, 100) }}%</span>
                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span>Quiz Average:</span>
                    <span class="fw-bold">{{ rand(70, 95) }}%</span>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span>Attendance:</span>
                    <span class="fw-bold">{{ rand(85, 100) }}%</span>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <span>Assignments Completed:</span>
                    <span class="fw-bold">{{ rand(15, 25) }}/25</span>
                </div>
            </div>
        </div>
        <div class="col-md-6">
