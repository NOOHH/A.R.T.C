...
<?php $__env->startSection('title', 'Professor Meetings - ' . $professor->professor_name); ?>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="h3 mb-1"><?php echo e($professor->professor_name); ?> - Meetings</h2>
                    <p class="text-muted">View and manage professor's meetings</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('admin.professors.index')); ?>" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left me-2"></i>Back to Professors
                    </a>
                    <button type="button" class="btn btn-primary" onclick="showSimpleModal('<?php echo e($professor->professor_id); ?>', '<?php echo e($professor->professor_name); ?>')">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h2 class="mb-0"><?php echo e($currentMeetings->count()); ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h2 class="mb-0"><?php echo e($todayMeetings->count()); ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h2 class="mb-0"><?php echo e($finishedMeetings->count()); ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-header bg-white border-bottom">
                    <ul class="nav nav-pills card-header-pills" id="meeting-tabs" role="tablist">
                        ...
                        <button class="nav-link active" id="current-tab" data-bs-toggle="pill" data-bs-target="#current" type="button" role="tab">
                                <i class="bi bi-broadcast me-2"></i>Live Meetings <span class="badge bg-warning ms-2"><?php echo e($currentMeetings->count()); ?></span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                        <button class="nav-link" id="today-tab" data-bs-toggle="pill" data-bs-target="#today" type="button" role="tab">
                                <i class="bi bi-calendar-day me-2"></i>Current Meetings <span class="badge bg-info ms-2"><?php echo e($todayMeetings->count()); ?></span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="upcoming-tab" data-bs-toggle="pill" data-bs-target="#upcoming" type="button" role="tab">
                                <i class="bi bi-calendar-plus me-2"></i>Upcoming <span class="badge bg-primary ms-2"><?php echo e($upcomingMeetings->count()); ?></span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="finished-tab" data-bs-toggle="pill" data-bs-target="#finished" type="button" role="tab">
                                <i class="bi bi-check-circle me-2"></i>Finished <span class="badge bg-success ms-2"><?php echo e($finishedMeetings->count()); ?></span>
                            </button>
                        </li>
                    </ul>
                </div>
                <div class="card-body overflow-hidden">
                    <div class="tab-content" id="meeting-tabContent">
                                        ...
                                        <div class="col">
                                            <div class="meeting-card card border-warning h-100">
                                                <div class="card-header bg-warning text-dark">
                                                    <h6 class="mb-0"><?php echo e($meeting->title); ?></h6>
                                                </div>
                                                <div class="card-body">
                                                    <p class="card-text">
                                                        <strong>Program:</strong> <?php echo e($meeting->batch && $meeting->batch->program ? $meeting->batch->program->program_name : 'Unknown Program'); ?><br>
                                                        <strong>Batch:</strong> <?php echo e($meeting->batch ? $meeting->batch->batch_name : 'Unknown Batch'); ?><br>
                                                        <strong>Date:</strong> <?php echo e(\Carbon\Carbon::parse($meeting->meeting_date)->format('M d, Y h:i A')); ?><br>
                                                        <strong>Duration:</strong> <?php echo e($meeting->duration_minutes); ?> minutes
                                                    </p>
                                                    <?php if($meeting->meeting_url): ?>
                                                        <a href="<?php echo e($meeting->meeting_url); ?>" target="_blank" class="btn btn-sm btn-warning">
                                                            <i class="bi bi-camera-video me-1"></i>Join Meeting
                                                        </a>
                                                    <?php endif; ?>
                                                    <form action="<?php echo e(route('admin.professors.deleteMeeting', [$professor->professor_id, $meeting->meeting_id])); ?>" method="POST" style="display:inline-block;">
                                                        <?php echo csrf_field(); ?>
                        ...
                        <div class="tab-pane fade" id="today" role="tabpanel">
                            <?php if($todayMeetingsFiltered->count() > 0): ?>
                                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-3">
                                    <?php $__currentLoopData = $todayMeetingsFiltered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col">
                                            <div class="meeting-card card border-info h-100">
                                                ...
                                                <div class="card-body">
                                                    <p class="card-text">
                                                        <strong>Program:</strong> <?php echo e($meeting->batch && $meeting->batch->program ? $meeting->batch->program->program_name : 'Unknown Program'); ?><br>
                                                        <strong>Batch:</strong> <?php echo e($meeting->batch ? $meeting->batch->batch_name : 'Unknown Batch'); ?><br>
                                                        <strong>Time:</strong> <?php echo e(\Carbon\Carbon::parse($meeting->meeting_date)->format('h:i A')); ?><br>
                                                        <strong>Duration:</strong> <?php echo e($meeting->duration_minutes); ?> minutes<br>
                                                        <strong>Status:</strong> <span class="badge bg-<?php echo e($meeting->status === 'ongoing' ? 'warning' : ($meeting->status === 'completed' ? 'success' : 'secondary')); ?>"><?php echo e(ucfirst($meeting->status)); ?></span>
                                                    </p>
                                                    <?php if($meeting->description): ?>
                                                        <p class="card-text"><small class="text-muted"><?php echo e($meeting->description); ?></small></p>
                                                    <?php endif; ?>
                                                    <?php if($meeting->meeting_url): ?>
                                                        <a href="<?php echo e($meeting->meeting_url); ?>" target="_blank" class="btn btn-sm btn-info">
                        ...
                        <div class="tab-pane fade" id="upcoming" role="tabpanel">
                            <?php if($upcomingMeetingsFiltered->count() > 0): ?>
                                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-3">
                                    <?php $__currentLoopData = $upcomingMeetingsFiltered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col">
                                            <div class="meeting-card card border-primary h-100">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if($meeting->meeting_url): ?>
                                                        <a href="<?php echo e($meeting->meeting_url); ?>" target="_blank" class="btn btn-sm btn-primary">
                                                            <i class="bi bi-camera-video me-1"></i>Meeting Link
                                                        </a>
                                                    <?php endif; ?>
                                                    <form action="<?php echo e(route('admin.professors.deleteMeeting', [$professor->professor_id, $meeting->meeting_id])); ?>" method="POST" style="display:inline-block;">
                        ...
                        <div class="tab-pane fade" id="finished" role="tabpanel">
                            <?php if($finishedMeetingsFiltered->count() > 0): ?>
                                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-3">
                                    <?php $__currentLoopData = $finishedMeetingsFiltered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col">
                                                    ...
                                                    <?php if($meeting->actual_start_time && $meeting->actual_end_time): ?>
                                                        <p class="card-text">
                                                            <small class="text-success">
                                                                ...
                                                                Actual duration: <?php echo e(\Carbon\Carbon::parse($meeting->actual_start_time)->diffInMinutes(\Carbon\Carbon::parse($meeting->actual_end_time))); ?> minutes
                                                            </small>
                                                        </p>
                                                    <?php endif; ?>
                                                    <form action="<?php echo e(route('admin.professors.deleteMeeting', [$professor->professor_id, $meeting->meeting_id])); ?>" method="POST" style="display:inline-block;">
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\admin\professors\meetings.blade.php ENDPATH**/ ?>