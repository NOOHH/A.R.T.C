    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('images/ARTC_logo.png')); ?>" alt="ARTC" height="40" class="me-2">
                <span>ARTC</span>
            </a>
            
            <div class="navbar-nav ms-auto">
                <a href="<?php echo e(url('/')); ?>" class="btn btn-outline-primary me-2">
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\layouts\public.blade.php ENDPATH**/ ?>