...
<style>
  ...
  /* PACKAGE CARDS (Legacy styles for compatibility) */
  .package-card {
  ...
  .learning-mode-card.selected {
    border-color: #1c2951;
    background: linear-gradient(145deg, #e0f3ff 0%, #f0f8ff 100%);
    box-shadow: 0 8px 25px rgba(28,41,81,0.2);
  }
  .mode-icon {
    font-size: 3rem;
    margin-bottom: 15px;
...
function validateStep3() {
    ...
    const allValidationsPassed = isEmailValid && isPasswordValid && isPasswordConfirmValid && !emailHasError;
