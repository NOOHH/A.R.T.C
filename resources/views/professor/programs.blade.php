...
<div class="container-fluid">
    ...
    @if($assignedPrograms->count() > 0)
        <!-- Programs Grid -->
        <div class="row">
            @foreach($assignedPrograms as $index => $program)
                <div class="col-md-6 col-xl-4 mb-4 fade-in-up stagger-animation" style="--animation-order: {{ $index }}">
                    <div class="program-card">
                        <div class="card-body p-4">
                            ...
                            <h5 class="card-title fw-bold mb-3 text-dark">{{ $program->program_name }}</h5>
                            ...
                            <div class="program-stats">
                                <div class="stat-item">
                                    ...
                                    <div>
                                        <div class="fw-semibold text-dark">{{ $program->students->count() }} Students</div>
                                ...
                                <div class="stat-item">
                                    ...
                                    <div>
                                        <div class="fw-semibold text-dark">{{ $program->modules->count() }} Modules</div>
