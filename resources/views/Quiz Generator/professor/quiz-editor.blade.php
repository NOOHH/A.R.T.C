        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('professor.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('quiz-generator') }}">Quiz Generator</a></li>
                            <li class="breadcrumb-item active">Edit Questions</li>
                        </ol>
                    </nav>
                </div>
                <div>
                    <a href="{{ route('quiz-generator') }}" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left"></i> Back to Quizzes
                    </a>
                    <a href="{{ route('quiz-generator.preview', $quiz->quiz_id) }}" class="btn btn-outline-primary">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <strong>Title:</strong> {{ $quiz->quiz_title }}<br>
                            <strong>Program:</strong> {{ $quiz->program->program_name ?? 'N/A' }}<br>
                            <strong>Module:</strong> {{ $quiz->module->module_name ?? 'N/A' }}
                        </div>
                        <div class="col-md-6">
                            <strong>Course:</strong> {{ $quiz->course->subject_name ?? 'N/A' }}<br>
                            <strong>Questions:</strong> <span id="question-count">{{ $quiz->questions->count() }}</span><br>
                ...
                <div class="card-body">
                    <div id="questions-container">
                        @foreach($quiz->questions as $index => $question)
                            <div class="question-item card mb-3" data-question-id="{{ $question->question_id }}">
                                <div class="card-header d-flex justify-content-between align-items-center">
