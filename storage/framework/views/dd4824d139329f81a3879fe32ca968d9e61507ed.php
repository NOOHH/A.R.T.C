            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <form action="<?php echo e(route('cloud-security.generate')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
                    ...
                    <div class="mt-4">
                        ...
                        <form action="<?php echo e(route('cloud-security.upload')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('form[action="<?php echo e(route("cloud-security.generate")); ?>"]').addEventListener('submit', function() {
    ...
    document.querySelector('form[action="<?php echo e(route("cloud-security.upload")); ?>"]').addEventListener('submit', function() {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\cloud-security\quiz-generator.blade.php ENDPATH**/ ?>