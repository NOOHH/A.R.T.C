...
<div class="dynamic-form-container">
    ...
    <?php $__currentLoopData = $requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requirement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($requirement->field_type === 'section'): ?>
            <div class="row mb-4">
                <div class="col-12">
                    <h4 class="border-bottom pb-2 mb-3 text-primary fw-bold">
                        <?php echo e($requirement->section_name); ?>
        ...
        <?php if($requirement->section_name && $requirement->section_name !== $currentSection): ?>
            <div class="row mb-4">
                <div class="col-12">
                    <h4 class="border-bottom pb-2 mb-3 text-primary fw-bold">
                        <?php echo e($requirement->section_name); ?>
        ...
        <div class="form-group mb-3" data-field="<?php echo e($requirement->field_name); ?>">
            <?php if($requirement->field_type === 'text' || $requirement->field_type === 'email' || $requirement->field_type === 'tel'): ?>
                <label for="<?php echo e($requirement->field_name); ?>" class="form-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>">
                    <?php echo e($requirement->field_label); ?>

                    <?php if($requirement->is_required): ?><span class="text-danger">*</span><?php endif; ?>
                </label>
                <input type="<?php echo e($requirement->field_type); ?>" 
                       class="form-control" 
                       id="<?php echo e($requirement->field_name); ?>" 
                       name="<?php echo e($requirement->field_name); ?>"
                       placeholder="<?php echo e($requirement->field_label); ?>"
                       <?php if($requirement->is_required): ?> required <?php endif; ?>>
            
            <?php elseif($requirement->field_type === 'date'): ?>
                <label for="<?php echo e($requirement->field_name); ?>" class="form-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>">
                    <?php echo e($requirement->field_label); ?>
            ...
            <?php elseif($requirement->field_type === 'file'): ?>
                <label for="<?php echo e($requirement->field_name); ?>" class="form-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>">
                    <?php echo e($requirement->field_label); ?>
                ...
                <div class="file-upload-container">
                    <button type="button" class="btn btn-outline-primary file-upload-btn" data-field="<?php echo e($requirement->field_name); ?>">
                        <i class="bi bi-cloud-upload"></i> <?php echo e($requirement->field_label); ?>
                    ...
                    <input type="file" 
                           ...
                           name="<?php echo e($requirement->field_name); ?>"
                           <?php if($requirement->is_required): ?> required <?php endif; ?>>
                    <div class="file-status mt-2" id="status-<?php echo e($requirement->field_name); ?>"></div>
                </div>
            
            <?php elseif($requirement->field_type === 'textarea'): ?>
                <label for="<?php echo e($requirement->field_name); ?>" class="form-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>">
                    <?php echo e($requirement->field_label); ?>
                ...
                <textarea class="form-control" 
                          ...
                          rows="3"
                          placeholder="<?php echo e($requirement->field_label); ?>"
                          <?php if($requirement->is_required): ?> required <?php endif; ?>></textarea>
            
            <?php elseif($requirement->field_type === 'number'): ?>
                <label for="<?php echo e($requirement->field_name); ?>" class="form-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>">
                    <?php echo e($requirement->field_label); ?>
            ...
            <?php elseif($requirement->field_type === 'checkbox'): ?>
                <div class="form-check">
                    <input type="checkbox" 
                           ...
                           value="1"
                           <?php if($requirement->is_required): ?> required <?php endif; ?>>
                    <label class="form-check-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>" for="<?php echo e($requirement->field_name); ?>">
                        <?php echo e($requirement->field_label); ?>
            ...
            <?php elseif($requirement->field_type === 'radio'): ?>
                <label class="form-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>">
                    <?php echo e($requirement->field_label); ?>

                    <?php if($requirement->is_required): ?><span class="text-danger">*</span><?php endif; ?>
                </label>
                <?php if($requirement->field_options): ?>
                    <?php $__currentLoopData = $requirement->field_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-check">
                            <input type="radio" 
                                   class="form-check-input" 
                                   id="<?php echo e($requirement->field_name); ?>_<?php echo e($index); ?>" 
                                   name="<?php echo e($requirement->field_name); ?>"
                                   value="<?php echo e($option); ?>"
                                   <?php if($requirement->is_required): ?> required <?php endif; ?>>
                            <label class="form-check-label" for="<?php echo e($requirement->field_name); ?>_<?php echo e($index); ?>">
                                <?php echo e($option); ?>
            ...
            <?php elseif($requirement->field_type === 'select'): ?>
                <label for="<?php echo e($requirement->field_name); ?>" class="form-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>">
                    <?php echo e($requirement->field_label); ?>
                ...
                <?php if($requirement->field_name === 'education_level' && $requirement->field_options): ?>
                    <div class="education-buttons d-flex justify-content-center gap-3 mb-2">
                        <?php $__currentLoopData = $requirement->field_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" 
                                    class="btn btn-outline-<?php echo e($index === 0 ? 'primary' : 'success'); ?> education-btn" 
                                    data-education="<?php echo e(strtolower($option)); ?>" 
                                    onclick="selectEducationLevel('<?php echo e(strtolower($option)); ?>', '<?php echo e($requirement->field_name); ?>')">
                                <i class="bi bi-<?php echo e($option === 'Undergraduate' ? 'mortarboard' : 'award'); ?> me-2"></i><?php echo e($option); ?>
                    ...
                    <input type="hidden" 
                           id="<?php echo e($requirement->field_name); ?>" 
                           name="<?php echo e($requirement->field_name); ?>"
                           value="<?php echo e(old($requirement->field_name)); ?>"
                           <?php if($requirement->is_required): ?> required <?php endif; ?>>
                <?php else: ?>
                    ...
                    <select class="form-select" 
                        ...
                        <?php if($requirement->field_options): ?>
                            <?php $__currentLoopData = $requirement->field_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php elseif($requirement->field_type === 'module_selection'): ?>
                <label for="<?php echo e($requirement->field_name); ?>" class="form-label <?php echo e($requirement->is_bold ? 'fw-bold' : ''); ?>">
                    <?php echo e($requirement->field_label); ?>
                ...
                <?php if($availableModules->count() > 0): ?>
                    <div class="module-selection-container">
                        <?php $__currentLoopData = $availableModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check mb-2">
                                <input type="checkbox" 
                                       class="form-check-input" 
                                       id="module_<?php echo e($module->modules_id); ?>" 
                                       name="<?php echo e($requirement->field_name); ?>[]"
                                       value="<?php echo e($module->modules_id); ?>"
                                       <?php if($requirement->is_required && $loop->first): ?> required <?php endif; ?>>
                                <label class="form-check-label" for="module_<?php echo e($module->modules_id); ?>">
                                    <strong><?php echo e($module->module_name); ?></strong>
                                    <?php if($module->module_description): ?>
                                        <br><small class="text-muted"><?php echo e($module->module_description); ?></small>
                                    <?php endif; ?>
                                </label>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php $__errorArgs = [$requirement->field_name];
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\components\dynamic-enrollment-form.blade.php ENDPATH**/ ?>