...
<head>
    ...
    <script>
        ...
        ?>
        window.myId = <?php echo json_encode($id, 15, 512) ?>;
        window.myName = <?php echo json_encode($name, 15, 512) ?>;
        window.userRole = <?php echo json_encode($role, 15, 512) ?>;
        window.isAuthenticated = <?php echo json_encode($user !== null, 15, 512) ?>;
        // DEBUG: show the session data for troubleshooting
        window._sessionDebug = <?php echo json_encode($debugData, 15, 512) ?>;
    ...
    <?php echo \App\Helpers\SettingsHelper::getSidebarCSS('admin'); ?>
    ...
    :root {
        ...
        --sidebar-primary: <?php echo e($adminColors['primary_color']); ?>;
        --sidebar-secondary: <?php echo e($adminColors['secondary_color']); ?>;
        /* Derived theme tokens */
        --sidebar-bg: linear-gradient(135deg, var(--sidebar-primary) 0%, var(--sidebar-secondary) 100%);
        --sidebar-text: <?php echo e($adminColors['text_color']); ?>;
        --sidebar-text-muted: #9ca3af;
        --sidebar-hover: <?php echo e(Str::startsWith($adminColors['hover_color'],'#') ? $adminColors['hover_color'] : 'rgba(255,255,255,0.1)'); ?>;
        --sidebar-active: <?php echo e(Str::startsWith($adminColors['accent_color'],'#') ? $adminColors['accent_color'] : 'rgba(255,255,255,0.2)'); ?>33;
        ...
        --admin-sidebar-accent: <?php echo e($adminColors['accent_color']); ?>;
    }
    ...
    <script>
        ...
        window.applyAdminSidebarVars({
            sidebarPrimary: "<?php echo e($adminColors['primary_color']); ?>",
            sidebarSecondary: "<?php echo e($adminColors['secondary_color']); ?>"
        });
        console.log('[AdminSidebar][Init]', <?php echo json_encode($adminColors, 15, 512) ?>);
    console.log('[AdminSidebar][DB Section Raw]', <?php echo json_encode(\App\Models\UiSetting::getSection('admin_sidebar')->toArray(), 15, 512) ?>);
    </script>
...
<div class="admin-container">
    ...
    <?php echo $__env->make('admin.admin-layouts.admin-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <!-- Main Content Area -->
    <div class="main-content-area" id="mainContentArea">
        <!-- Include Header Component -->
        <?php echo $__env->make('admin.admin-layouts.admin-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('js/admin/admin-sidebar.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/admin/admin-dashboard/admin-dashboard-layout.blade.php ENDPATH**/ ?>