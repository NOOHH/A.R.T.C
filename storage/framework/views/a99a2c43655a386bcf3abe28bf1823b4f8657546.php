...
<div id="professor-features" class="sidebar-section">
    ...
    <form id="professorFeaturesForm" action="<?php echo e(route('smartprep.dashboard.settings.update.professor-features', ['website' => $selectedWebsite->id])); ?>" method="POST" onsubmit="updateProfessorFeatures(event)">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="professorModuleManagementEnabled" name="professor_module_management_enabled" <?php echo e(($settings['professor_features']['professor_module_management_enabled'] ?? false) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="professorAnnouncementManagementEnabled" name="professor_announcement_management_enabled" <?php echo e(($settings['professor_features']['professor_announcement_management_enabled'] ?? false) ? 'checked' : ''); ?>>
