                ...
                <div class="sidebar-section active" id="general-settings">
                    ...
                    <form id="generalForm" onsubmit="updateGeneral(event)">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="site_title" value="<?php echo e($settings['general']['site_title'] ?? 'Your Company Name'); ?>" placeholder="Enter site title">
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\smartprep\dashboard\customize-website-new.blade.php ENDPATH**/ ?>