...
<?php $__env->startSection('title', 'Modular Enrollment - Individual Module Selection'); ?>
    ...
    <script>
        ...
        const planConfig = {
            full: {
                ...
                enableAsynchronous: <?php echo e(isset($fullPlan) && $fullPlan->enable_asynchronous ? 'true' : 'false'); ?>

            },
            modular: {
                enableSynchronous: <?php echo e(isset($modularPlan) && $modularPlan->enable_synchronous ? 'true' : 'false'); ?>,
                enableAsynchronous: <?php echo e(isset($modularPlan) && $modularPlan->enable_asynchronous ? 'true' : 'false'); ?>
        ...
        const formRequirements = <?php echo json_encode($formRequirements ?? [], 15, 512) ?>;

        // Education levels data
        const educationLevels = <?php echo json_encode($educationLevels ?? [], 15, 512) ?>;
...
<div class="container-fluid py-4">
    ...
    <!-- Form -->
    <form action="<?php echo e(route('enrollment.modular.submit')); ?>" method="POST" enctype="multipart/form-data" id="enrollmentForm">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-grid">
                <?php if($packages && count($packages) > 0): ?>
                    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="selection-card" data-package-id="<?php echo e($package->package_id); ?>" 
                             data-program-id="<?php echo e($package->program_id); ?>" 
                             data-module-count="<?php echo e($package->module_count); ?>"
                             onclick="selectPackage(<?php echo e($package->package_id); ?>, <?php echo e($package->program_id); ?>, <?php echo e($package->module_count); ?>)">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo e($package->package_name); ?></h3>
                                <div class="card-price">₱<?php echo e(number_format($package->price ?? $package->amount, 2)); ?></div>
                            </div>
                            <div class="card-description">
                                <?php echo e($package->description ?? 'Flexible modular learning package'); ?>

                            </div>
                            <ul class="card-features">
                                <li><?php echo e($package->module_count); ?> modules included</li>
        ...
        <div class="step-content" id="content-4">
            ...
            <div class="learning-mode-grid">
                <?php if(isset($modularPlan) && $modularPlan->enable_synchronous): ?>
                ...
                <?php if(isset($modularPlan) && $modularPlan->enable_asynchronous): ?>
                    ...
                    <?php if(isset($educationLevels) && $educationLevels->count() > 0): ?>
                        <?php $__currentLoopData = $educationLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($level->level_name); ?>" 
                                    data-file-requirements="<?php echo e(json_encode($level->getFileRequirementsForPlan('general'))); ?>">
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\registration\MULTI STEPModular_enrollment.blade.php ENDPATH**/ ?>