...
.program-content {
    background: white;
    margin-top: -10px;   /* Adjust to move up closer */
    margin-left: -350px;
    margin-right: auto;
    border-radius: 30px 30px 0 0;
    padding: 40px;      /* Adjust if you want space inside */
    position: relative;
    z-index: 2;
    width: 100000px;      /* Or any fixed width you want */
}
...
@endpush
@section('content')
<div class="program-top-container">
                            ...
                            <div class="module-card">
                                ...
                                <div class="module-meta">
                                    ...
                                    @if($module->module_order)
                                        <span class="meta-tag">
                                            <i class="bi bi-list-ol"></i> Order: {{ $module->module_order }}
                                        </span>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="cta-section">
                ...
                <div class="cta-buttons">
                    <a href="{{ route('enrollment.modular', ['program_id' => $program->program_id]) }}" class="btn-primary-cta">
                        <i class="bi bi-play-circle-fill"></i> Enroll Now
                    </a>
