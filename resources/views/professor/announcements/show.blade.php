            ...
            <div class="card announcement-card">
                ...
                <div class="announcement-header">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <h1 class="h2 mb-0">{{ $announcement->title }}</h1>
                        <span class="badge type-badge announcement-type-{{ $announcement->type }}">
                            {{ ucfirst($announcement->type) }}
                        </span>
                    </div>
                    
                    @if($announcement->description)
                        <p class="lead mb-0 opacity-90">{{ $announcement->description }}</p>
                    @endif
                </div>
                        ...
                        <div class="video-container">
                            ...
                            @else
                                <div class="alert alert-info">
                                    ...
                                    <a href="{{ $announcement->video_link }}" target="_blank" class="alert-link">
                                        View Video
                                    </a>
                                </div>
                            @endif
                ...
                <div class="action-buttons">
                    <div class="btn-group-custom">
                        <a href="{{ route('professor.announcements.edit', $announcement) }}" class="btn-custom btn-edit">
                            <i class="bi bi-pencil-square"></i>Edit
                        </a>
                        
                        <form action="{{ route('professor.announcements.toggle-status', $announcement) }}" 
                        ...
                        <form action="{{ route('professor.announcements.destroy', $announcement) }}" 
                              method="POST" class="d-inline"
                        ...
                        <a href="{{ route('professor.announcements.index') }}" class="btn-custom btn-back">
                    ...
                    <div class="meta-info">
                        <div class="meta-item">
                            ...
                            <div>
                                ...
                                <span class="text-muted">{{ $announcement->created_at->format('M d, Y g:i A') }}</span>
                            </div>
                        </div>
                        ...
                        @if($announcement->updated_at != $announcement->created_at)
                            <div class="meta-item">
                                ...
                                <div>
                                    ...
                                    <span class="text-muted">{{ $announcement->updated_at->format('M d, Y g:i A') }}</span>
                                </div>
                            </div>
                        @endif
                        
                        <div class="meta-item">
                            <i class="bi bi-{{ $announcement->is_published ? 'check-circle' : 'clock' }}"></i>
                            <div>
                        ...
                        @if($announcement->publish_date)
                            <div class="meta-item">
                                ...
                                <div>
                                    ...
                                    <span class="text-muted">{{ $announcement->publish_date->format('M d, Y g:i A') }}</span>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($announcement->expire_date)
                            <div class="meta-item">
                                ...
                                <div>
                                    ...
                                    <span class="text-muted">{{ $announcement->expire_date->format('M d, Y g:i A') }}</span>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="meta-item">
                            ...
                            <div>
                                ...
                                <span class="text-muted">{{ $announcement->professor->first_name ?? 'Professor' }} {{ $announcement->professor->last_name ?? '' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="target-info">
                        @if($announcement->target_users && count($announcement->target_users) > 0)
                            <div class="target-section">
                                <strong class="text-primary">
                                    <i class="bi bi-people me-2"></i>User Types:
                                </strong>
                                <div class="target-list">
                                    @foreach($announcement->target_users as $userType)
                                        <span class="target-tag">{{ ucfirst($userType) }}</span>
                                    @endforeach
                                </div>
                            </div>
                        @endif

                        @if($announcement->target_programs && count($announcement->target_programs) > 0)
                            <div class="target-section">
                                <strong class="text-primary">
                                    <i class="bi bi-book me-2"></i>Programs:
                                </strong>
                                <div class="target-list">
                                    @foreach($targetProgramNames as $programName)
                                        <span class="target-tag">{{ $programName }}</span>
                                    @endforeach
                                </div>
                            </div>
                        @endif

                        @if($announcement->target_batches && count($announcement->target_batches) > 0)
                            <div class="target-section">
                                <strong class="text-primary">
                                    <i class="bi bi-collection me-2"></i>Batches:
                                </strong>
                                <div class="target-list">
                                    @foreach($targetBatchNames as $batchName)
                                        <span class="target-tag">{{ $batchName }}</span>
                                    @endforeach
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="target-section">
                                ...
                                <div class="target-list">
                                    @foreach($announcement->target_plans as $plan)
                                        <span class="target-tag">{{ ucfirst($plan) }}</span>
                                    @endforeach
                                </div>
                            </div>
                        @endif
