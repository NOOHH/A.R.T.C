...
} elseif ($_instance->childHasBeenRendered('1ybPIfb')) {
    $componentId = $_instance->getRenderedChildComponentId('1ybPIfb');
    $componentTag = $_instance->getRenderedChildComponentTagName('1ybPIfb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1ybPIfb');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('1ybPIfb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('sx8ZC4e')) {
    $componentId = $_instance->getRenderedChildComponentId('sx8ZC4e');
    $componentTag = $_instance->getRenderedChildComponentTagName('sx8ZC4e');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sx8ZC4e');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('sx8ZC4e', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\vendor\filament\filament\resources\views\components\topbar.blade.php ENDPATH**/ ?>