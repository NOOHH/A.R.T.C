        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('smartprep.admin.dashboard')); ?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('smartprep.admin.website-requests')); ?>">
                            ...
                            <?php if($stats['pending_requests'] > 0): ?>
                                <span class="badge bg-warning text-dark ms-1"><?php echo e($stats['pending_requests']); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            ...
                            ?>
                            <?php echo e($currentUser ? $currentUser->name : 'Admin'); ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end mt-4 mt-lg-0">
                    <div class="d-flex flex-column align-items-lg-end">
                        <div class="text-white-50 mb-2"><?php echo e(now()->format('l, F j, Y')); ?></div>
                        <div class="fs-4 fw-bold"><?php echo e(now()->format('g:i A')); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 stats-grid">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stats-card">
                    ...
                    <div class="stats-number"><?php echo e($stats['active_websites']); ?></div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stats-card">
                    ...
                    <div class="stats-number"><?php echo e($stats['pending_requests']); ?></div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="stats-card">
                    ...
                    <div class="stats-number"><?php echo e($stats['total_clients']); ?></div>
                ...
                <div class="content-card">
                    ...
                    <div class="card-body-custom">
                        <?php if($recentRequests->count() > 0): ?>
                            <?php $__currentLoopData = $recentRequests->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <div class="list-item-title"><?php echo e($request->business_name); ?></div>
                                        <div class="list-item-meta"><?php echo e($request->user->name); ?> • <?php echo e($request->created_at->diffForHumans()); ?></div>
                                    </div>
                                    <span class="badge-status badge-<?php echo e($request->status_color); ?>"><?php echo e($request->status_text); ?></span>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-3 bg-light">
                                <a href="<?php echo e(route('smartprep.admin.website-requests')); ?>" class="btn-outline-custom btn-sm-custom w-100">
                ...
                <div class="content-card">
                    ...
                    <div class="card-body-custom">
                        <?php if($recentClients->count() > 0): ?>
                            <?php $__currentLoopData = $recentClients->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-item">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <div class="list-item-title"><?php echo e($client->name); ?></div>
                                    ...
                                    <a href="/t/<?php echo e($client->slug); ?>" class="btn-outline-custom btn-sm-custom" target="_blank">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-3 bg-light">
                                <a href="<?php echo e(route('smartprep.admin.clients')); ?>" class="btn-outline-custom btn-sm-custom w-100">
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\smartprep\admin\dashboard.blade.php ENDPATH**/ ?>