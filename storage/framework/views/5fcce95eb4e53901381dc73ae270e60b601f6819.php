                ...
                <div class="sidebar-section active" id="general-settings">
                    ...
                    <form id="generalForm" onsubmit="updateGeneral(event)">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="email" class="form-control" name="contact_email" value="<?php echo e(Auth::user()->email); ?>" placeholder="Contact email">
                        </div>
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\dashboard\customize-website-old.blade.php ENDPATH**/ ?>