        ...
        <div class="card-body">
            <div class="tab-content" id="quizTabsContent">
                ...
                <div class="tab-pane fade show active" id="draft" role="tabpanel">
                    ...
                    <?php else: ?>
                        <?php echo $__env->make('Quiz Generator.professor.quiz-table', ['quizzes' => $draftQuizzes, 'status' => 'draft'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="tab-pane fade" id="published" role="tabpanel">
                    ...
                    <?php else: ?>
                        <?php echo $__env->make('Quiz Generator.professor.quiz-table', ['quizzes' => $publishedQuizzes, 'status' => 'published'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="tab-pane fade" id="archived" role="tabpanel">
                    ...
                    <?php else: ?>
                        <?php echo $__env->make('Quiz Generator.professor.quiz-table', ['quizzes' => $archivedQuizzes, 'status' => 'archived'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
async function saveQuiz(isDraft = true) {
    ...
    try {
        ...
        const url = isEdit ? 
            ...
            '<?php echo e(route("professor.quiz-generator.save-manual")); ?>';
...
<?php echo $__env->make('professor.professor-layouts.professor-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\Quiz Generator\professor\quiz-generator-overhauled.blade.php ENDPATH**/ ?>