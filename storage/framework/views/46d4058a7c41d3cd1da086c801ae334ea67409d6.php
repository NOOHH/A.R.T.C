...
<?php $__env->startSection('title', 'Student Assignment Submissions - A.R.T.C Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="filter-section">
            <form method="GET" action="<?php echo e(route('admin.submissions')); ?>">
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <select name="program_id" id="program_filter" class="form-select">
                            ...
                            <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($program->program_id); ?>" <?php echo e(request('program_id') == $program->program_id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="module_id" id="module_filter" class="form-select">
                            ...
                            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($module->module_id); ?>" <?php echo e(request('module_id') == $module->module_id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('admin.submissions')); ?>" class="btn btn-outline-secondary">
                        ...
                        <div class="submission-card">
                            <div class="submission-header">
                                <div class="flex-grow-1">
                                    <div class="student-info">
                                        <div class="student-avatar">
                                            <?php if($submission->student && $submission->student->user): ?>
                                                <?php echo e(substr($submission->student->user->user_firstname ?? 'N', 0, 1)); ?><?php echo e(substr($submission->student->user->user_lastname ?? 'A', 0, 1)); ?>
                                        ...
                                        <div class="student-details">
                                            <h5>
                                                <?php if($submission->student && $submission->student->user): ?>
                                                    <?php echo e($submission->student->user->user_firstname ?? 'Unknown'); ?> <?php echo e($submission->student->user->user_lastname ?? 'Student'); ?>
                                            ...
                                            <div class="text-muted">
                                                Student ID: <?php echo e($submission->student->student_id ?? 'N/A'); ?> | 
                                                Program: <?php echo e($submission->program->program_name ?? 'N/A'); ?>
                                ...
                                <div class="submission-status status-<?php echo e($submission->status); ?>">
                                    <i class="bi bi-<?php echo e($submission->status == 'graded' ? 'check-circle' : ($submission->status == 'reviewed' ? 'eye' : 'clock')); ?> me-2"></i>
                            ...
                            <div class="submission-body">
                                ...
                                <div class="assignment-details">
                                    <h6 class="mb-2">
                                        <i class="bi bi-file-earmark-text me-2"></i>
                                        Module: <?php echo e($submission->module->module_name ?? 'N/A'); ?>

                                    </h6>
                                    <?php if($submission->comments): ?>
                                        <p class="mb-0 text-muted"><?php echo e($submission->comments); ?></p>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="submission-metadata">
                                    <div class="metadata-item">
                                        ...
                                        <div class="metadata-value"><?php echo e($submission->submitted_at->format('M d, Y - h:i A')); ?></div>
                                    </div>
                                    <?php if($submission->status == 'graded' && $submission->grade !== null): ?>
                                        <div class="metadata-item">
                                            <div class="metadata-label">Grade</div>
                                            <div class="metadata-value">
                                                <span class="grade-badge grade-<?php echo e($submission->grade >= 90 ? 'excellent' : ($submission->grade >= 80 ? 'good' : ($submission->grade >= 70 ? 'average' : 'needs-improvement'))); ?>">
                                                    <?php echo e($submission->grade); ?>/100
                                                </span>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($submission->graded_at): ?>
                                        <div class="metadata-item">
                                            ...
                                            <div class="metadata-value"><?php echo e($submission->graded_at->format('M d, Y - h:i A')); ?></div>
                                        </div>
                                    <?php endif; ?>
                                    <div class="metadata-item">
                                        <div class="metadata-label">Files</div>
                                        <div class="metadata-value"><?php echo e(count($submission->files ?? [])); ?> file(s)</div>
                                    </div>
                                </div>

                                <!-- Submitted Files -->
                                <?php if($submission->files && count($submission->files) > 0): ?>
                                        ...
                                        <?php $__currentLoopData = $submission->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
                                                <div class="file-preview">
                                                    <div class="file-icon">
                                                        <i class="bi bi-<?php echo e(str_contains($file['type'], 'pdf') ? 'file-earmark-pdf' : (str_contains($file['type'], 'image') ? 'file-earmark-image' : (str_contains($file['type'], 'word') ? 'file-earmark-word' : 'file-earmark'))); ?>"></i>
                                                    </div>
                                                    <div class="file-info">
                                                        <h6 class="mb-1"><?php echo e($file['original_filename'] ?? ($file['original_name'] ?? ($file['name'] ?? 'File'))); ?></h6>
                                                        <p class="mb-2 text-muted"><?php echo e(round($file['size'] / 1024, 2)); ?> KB</p>
                                                        <div class="d-flex gap-2 justify-content-center">
                                                            <a href="<?php echo e(asset('storage/' . $file['path'])); ?>" target="_blank" class="btn btn-view btn-sm">
                                                                <i class="bi bi-eye me-1"></i>View
                                                            </a>
                                                            <a href="<?php echo e(asset('storage/' . $file['path'])); ?>" download class="btn btn-download btn-sm">
                                ...
                                <div class="d-flex gap-2 justify-content-end mt-3">
                                    <?php if($submission->status != 'graded'): ?>
                                        <button type="button" class="btn btn-grade btn-action" onclick="openGradingModal(<?php echo e($submission->id); ?>, '<?php echo e(($submission->student && $submission->student->user) ? $submission->student->user->user_firstname . ' ' . $submission->student->user->user_lastname : 'Unknown Student'); ?>', <?php echo e($submission->grade ?? 'null'); ?>, '<?php echo e(addslashes($submission->feedback ?? '')); ?>')">
                                            <i class="bi bi-award me-2"></i>Grade Assignment
                                        </button>
                                    <?php else: ?>
                                        <button type="button" class="btn btn-warning btn-action" onclick="openGradingModal(<?php echo e($submission->id); ?>, '<?php echo e(($submission->student && $submission->student->user) ? $submission->student->user->user_firstname . ' ' . $submission->student->user->user_lastname : 'Unknown Student'); ?>', <?php echo e($submission->grade ?? 'null'); ?>, '<?php echo e(addslashes($submission->feedback ?? '')); ?>')">
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/admin/admin-student-submissions/admin-submission.blade.php ENDPATH**/ ?>