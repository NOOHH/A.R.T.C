...
<style>
<?php echo App\Helpers\SettingsHelper::getEnrollmentStyles(); ?>
            ...
            <div class="row justify-content-center g-4">
                <div class="col-12 col-md-6 col-lg-5 d-flex">
                    <div class="enrollment-card program-card enrollment-program-card h-100 w-100">
                        ...
                        <a href="<?php echo e(tenant_enrollment_url('full')); ?>" 
                ...
                <div class="col-12 col-md-6 col-lg-5 d-flex">
                    <div class="enrollment-card program-card enrollment-program-card h-100 w-100">
                        ...
                        <a href="<?php echo e(tenant_enrollment_url('modular')); ?>" 
                                class="btn enrollment-btn enroll-btn" 
                                id="modular-enroll-btn"
                                data-url="<?php echo e(tenant_enrollment_url('modular')); ?>"
                                data-target="modular_enrollment"
                                onclick="window.location.href='<?php echo e(tenant_enrollment_url('modular')); ?>'; return false;">
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                if (modularBtn) {
                                    ...
                                    modularBtn.addEventListener('click', function(e) {
                                        ...
                                        try {
                                            window.location.href = '<?php echo e(tenant_enrollment_url('modular')); ?>';
                                            return false;
                                        } catch (err) {
                                        ...
                                        try {
                                            window.open('<?php echo e(tenant_enrollment_url('modular')); ?>', '_self');
                                            return false;
                                        } catch (err) {
                                        ...
                                        try {
                                            ...
                                            form.method = 'GET';
                                            form.action = '<?php echo e(tenant_enrollment_url('modular')); ?>';
                        ...
                        <script>
                            ...
                            function tryModularEnrollment() {
                                ...
                                const tryRoutes = [
                                    '<?php echo e(tenant_enrollment_url('modular')); ?>',
                                    '/modular-enrollment',
                                    '/emergency-modular',
                                    '/go-to-modular.php',
                                    '/test-modular.php'
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/welcome/enrollment.blade.php ENDPATH**/ ?>