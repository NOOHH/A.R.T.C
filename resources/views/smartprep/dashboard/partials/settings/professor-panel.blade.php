    ...
    <form id="professorForm" action="{{ route('smartprep.dashboard.settings.update.professor', ['website' => $selectedWebsite->id]) }}" method="POST">
        ...
        <div class="setting-group">
            ...
            <select id="professor_dashboard_layout" name="professor_dashboard_layout" class="form-select">
                <option value="overview" {{ ($settings['professor_dashboard_layout'] ?? 'overview') == 'overview' ? 'selected' : '' }}>Overview Dashboard</option>
                <option value="course-focused" {{ ($settings['professor_dashboard_layout'] ?? '') == 'course-focused' ? 'selected' : '' }}>Course-Focused</option>
                <option value="analytics" {{ ($settings['professor_dashboard_layout'] ?? '') == 'analytics' ? 'selected' : '' }}>Analytics-Heavy</option>
            </select>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="color-input-group">
                        <input type="color" id="professor_primary_color" name="professor_primary_color" 
                               ...
                               value="{{ $settings['professor_primary_color'] ?? '#28a745' }}">
                        <input type="text" class="form-control form-control-sm" 
                               value="{{ $settings['professor_primary_color'] ?? '#28a745' }}" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="color-input-group">
                        <input type="color" id="professor_secondary_color" name="professor_secondary_color" 
                               class="form-control form-control-color" 
                               value="{{ $settings['professor_secondary_color'] ?? '#6c757d' }}">
                        <input type="text" class="form-control form-control-sm" 
                               value="{{ $settings['professor_secondary_color'] ?? '#6c757d' }}" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="color-input-group">
                        <input type="color" id="professor_sidebar_color" name="professor_sidebar_color" 
                               class="form-control form-control-color" 
                               value="{{ $settings['professor_sidebar_color'] ?? '#f8f9fa' }}">
                        <input type="text" class="form-control form-control-sm" 
                               value="{{ $settings['professor_sidebar_color'] ?? '#f8f9fa' }}" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="color-input-group">
                        <input type="color" id="professor_accent_color" name="professor_accent_color" 
                               class="form-control form-control-color" 
                               value="{{ $settings['professor_accent_color'] ?? '#ffc107' }}">
                        <input type="text" class="form-control form-control-sm" 
                               value="{{ $settings['professor_accent_color'] ?? '#ffc107' }}" readonly>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="setting-group">
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_show_sidebar" name="professor_show_sidebar" class="form-check-input" 
                       value="1" {{ ($settings['professor_show_sidebar'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_collapsible_sidebar" name="professor_collapsible_sidebar" class="form-check-input" 
                       value="1" {{ ($settings['professor_collapsible_sidebar'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_show_quick_actions" name="professor_show_quick_actions" class="form-check-input" 
                       value="1" {{ ($settings['professor_show_quick_actions'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="setting-group">
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_bulk_actions" name="professor_bulk_actions" class="form-check-input" 
                       value="1" {{ ($settings['professor_bulk_actions'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_advanced_filters" name="professor_advanced_filters" class="form-check-input" 
                       value="1" {{ ($settings['professor_advanced_filters'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_export_options" name="professor_export_options" class="form-check-input" 
                       value="1" {{ ($settings['professor_export_options'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="setting-group">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select id="professor_grading_scale" name="professor_grading_scale" class="form-select">
                        <option value="percentage" {{ ($settings['professor_grading_scale'] ?? 'percentage') == 'percentage' ? 'selected' : '' }}>Percentage (0-100)</option>
                        <option value="letter" {{ ($settings['professor_grading_scale'] ?? '') == 'letter' ? 'selected' : '' }}>Letter Grades (A-F)</option>
                        <option value="points" {{ ($settings['professor_grading_scale'] ?? '') == 'points' ? 'selected' : '' }}>Points Based</option>
                        <option value="pass-fail" {{ ($settings['professor_grading_scale'] ?? '') == 'pass-fail' ? 'selected' : '' }}>Pass/Fail</option>
                    </select>
                </div>
                <div class="col-md-6">
                    ...
                    <select id="professor_grade_display" name="professor_grade_display" class="form-select">
                        <option value="numeric" {{ ($settings['professor_grade_display'] ?? 'numeric') == 'numeric' ? 'selected' : '' }}>Numeric Only</option>
                        <option value="letter" {{ ($settings['professor_grade_display'] ?? '') == 'letter' ? 'selected' : '' }}>Letter Only</option>
                        <option value="both" {{ ($settings['professor_grade_display'] ?? '') == 'both' ? 'selected' : '' }}>Both Numeric & Letter</option>
                    </select>
                </div>
            </div>
            <div class="form-check mt-2">
                <input type="checkbox" id="professor_auto_calculate" name="professor_auto_calculate" class="form-check-input" 
                       value="1" {{ ($settings['professor_auto_calculate'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_grade_comments" name="professor_grade_comments" class="form-check-input" 
                       value="1" {{ ($settings['professor_grade_comments'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="setting-group">
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_show_analytics" name="professor_show_analytics" class="form-check-input" 
                       value="1" {{ ($settings['professor_show_analytics'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_student_progress" name="professor_student_progress" class="form-check-input" 
                       value="1" {{ ($settings['professor_student_progress'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_engagement_metrics" name="professor_engagement_metrics" class="form-check-input" 
                       value="1" {{ ($settings['professor_engagement_metrics'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_automated_reports" name="professor_automated_reports" class="form-check-input" 
                       value="1" {{ ($settings['professor_automated_reports'] ?? false) ? 'checked' : '' }}>
        ...
        <div class="setting-group">
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_messaging" name="professor_messaging" class="form-check-input" 
                       value="1" {{ ($settings['professor_messaging'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_announcements" name="professor_announcements" class="form-check-input" 
                       value="1" {{ ($settings['professor_announcements'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="form-check">
                <input type="checkbox" id="professor_office_hours" name="professor_office_hours" class="form-check-input" 
                       value="1" {{ ($settings['professor_office_hours'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="color" id="professor_sidebar_primary_color" class="form-control form-control-color" value="{{ $settings['professor_sidebar']['primary_color'] ?? '#28a745' }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Secondary Color</label>
                    <input type="color" id="professor_sidebar_secondary_color" class="form-control form-control-color" value="{{ $settings['professor_sidebar']['secondary_color'] ?? '#6c757d' }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Accent Color</label>
                    <input type="color" id="professor_sidebar_accent_color" class="form-control form-control-color" value="{{ $settings['professor_sidebar']['accent_color'] ?? '#ffc107' }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Text Color</label>
                    <input type="color" id="professor_sidebar_text_color" class="form-control form-control-color" value="{{ $settings['professor_sidebar']['text_color'] ?? '#333333' }}">
                </div>
                <div class="col-md-6">
