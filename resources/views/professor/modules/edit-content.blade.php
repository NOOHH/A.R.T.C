    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('professor.content.update', $content->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="content_title" name="content_title" 
                                           value="{{ old('content_title', $content->content_title) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="content_description" name="content_description" 
                                      rows="3">{{ old('content_description', $content->content_description) }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if($content->content_path)
                                <small class="text-muted">
                                    Current file: {{ basename($content->content_path) }}
                                </small>
                            @endif
                        </div>
                        
                        <div class="mb-3" id="content_url_div" style="{{ $content->content_type == 'Link' ? 'display: block;' : 'display: none;' }}">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('professor.modules.index') }}" class="btn btn-secondary">Cancel</a>
