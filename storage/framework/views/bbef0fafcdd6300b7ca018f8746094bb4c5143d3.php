        ...
        <div class="col-12">
            ...
            <div class="page-header d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800">
                    <?php echo e((isset($history) && $history) ? 'Student Registration History' : 'Student Registration Pending'); ?>

                </h1>
                <div class="d-flex gap-2">
                    <?php if(isset($history) && $history): ?>
                        <a href="<?php echo e(route('admin.student.registration.pending')); ?>" class="btn btn-outline-primary">
                    ...
                    <?php else: ?>
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('admin.student.registration.rejected')); ?>">
                                    <i class="bi bi-person-x me-2"></i>Registration Rejected
                                </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('admin.student.registration.payment.rejected')); ?>">
                        ...
                        <a href="<?php echo e(route('admin.student.registration.history')); ?>" class="btn btn-outline-info">
            ...
            <?php if(!isset($history) || !$history): ?>
                ...
                ?>
                <?php if($rejectedRegistrations->count() > 0): ?>
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center bg-danger text-white">
                        ...
                        <div>
                            <small>Total: <?php echo e($rejectedRegistrations->count()); ?></small>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $rejectedRegistrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php echo e(($registration->firstname ?? '')); ?> 
                                            <?php echo e(($registration->middlename ?? '')); ?>

                                            <?php echo e(($registration->lastname ?? '')); ?>

                                        </td>
                                        <td>
                                            <?php if(isset($registration->user) && $registration->user): ?>
                                                <?php echo e($registration->user->email ?? 'N/A'); ?>

                                            <?php else: ?>
                                                N/A
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($registration->program_name ?? 'N/A'); ?></td>
                                        <td><?php echo e($registration->package_name ?? 'N/A'); ?></td>
                                        <td><?php echo e($registration->rejected_at ? \Carbon\Carbon::parse($registration->rejected_at)->format('M d, Y') : 'N/A'); ?></td>
                                        <td>
                                            <div class="text-truncate" style="max-width: 200px;" title="<?php echo e($registration->rejection_reason); ?>">
                                                <?php echo e($registration->rejection_reason ?? 'No reason provided'); ?>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button type="button" class="btn btn-sm btn-info" 
                                                        onclick="viewRejectedRegistrationDetails('<?php echo e($registration->registration_id); ?>')">
                                                    <i class="bi bi-eye"></i> View
                                                </button>
                                                <button type="button" class="btn btn-sm btn-warning" 
                                                        onclick="editRejectedFields('<?php echo e($registration->registration_id); ?>')">
                                                    <i class="bi bi-pencil"></i> Edit Rejection
                                                </button>
                                                <button type="button" class="btn btn-sm btn-secondary" style="display:inline-block !important;" onclick="undoRejection('<?php echo e($registration->registration_id); ?>')">
                ...
                ?>
                <?php if($resubmittedRegistrations->count() > 0): ?>
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center bg-warning text-dark">
                        ...
                        <div>
                            <small>Total: <?php echo e($resubmittedRegistrations->count()); ?></small>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $resubmittedRegistrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php echo e(($registration->firstname ?? '')); ?> 
                                            <?php echo e(($registration->middlename ?? '')); ?>
                                        ...
                                        <td><?php echo e($registration->program_name ?? 'N/A'); ?></td>
                                        <td><?php echo e($registration->package_name ?? 'N/A'); ?></td>
                                        <td><?php echo e($registration->resubmitted_at ? \Carbon\Carbon::parse($registration->resubmitted_at)->format('M d, Y') : 'N/A'); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button type="button" class="btn btn-sm btn-info" 
                                                        onclick="viewResubmissionComparison('<?php echo e($registration->registration_id); ?>')">
                                                    <i class="bi bi-eye"></i> View
                                                </button>
                                                <button type="button" class="btn btn-sm btn-success" 
                                                        onclick="approveResubmission('<?php echo e($registration->registration_id); ?>')">
                                                    <i class="bi bi-check-circle"></i> Approve
                                                </button>
                                                <button type="button" class="btn btn-sm btn-danger" 
                                                        onclick="rejectResubmission('<?php echo e($registration->registration_id); ?>')">
            ...
            <?php else: ?>
                ...
                ?>
                <?php if($approvedRegistrations->count() > 0): ?>
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <small class="text-muted">Total: <?php echo e($approvedRegistrations->count()); ?></small>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $approvedRegistrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php echo e(($registration->firstname ?? ($registration->student->firstname ?? ''))); ?> 
                                            <?php echo e(($registration->middlename ?? ($registration->student->middlename ?? ''))); ?>

                                            <?php echo e(($registration->lastname ?? ($registration->student->lastname ?? ''))); ?>
                                        ...
                                        <td>
                                            ...
                                            <?php elseif(isset($registration->email)): ?>
                                        ...
                                        <td><?php echo e($registration->program_name ?? ($registration->program ? $registration->program->program_name : 'N/A')); ?></td>
                                        <td><?php echo e($registration->package_name ?? ($registration->package ? $registration->package->package_name : 'N/A')); ?></td>
                                        <td>
                                            <?php if($registration->enrollment_type === 'modular' || $registration->enrollment_type === 'Modular'): ?>
                                                <?php
                                                    $selectedCourses = [];
                                                ...
                                                <?php if(!empty($selectedCourses)): ?>
                                                    ...
                                                    <div class="small">
                                                        ...
                                                        <?php echo e(implode(', ', $courseNames)); ?>

                                                    </div>
                                                <?php elseif(!empty($selectedModules)): ?>
                                                    <?php
                                                        $moduleNames = [];
                                                    ...
                                                    <div class="small">
                                                        ...
                                                        <?php echo e(implode(', ', $moduleNames)); ?>
                                                ...
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <span class="text-muted">N/A (<?php echo e(ucfirst($registration->enrollment_type ?? 'N/A')); ?>)</span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($registration->plan_name ?? ($registration->enrollment_type ? ucfirst($registration->enrollment_type) : 'N/A')); ?></td>
                                        <td><?php echo e($registration->created_at ? \Carbon\Carbon::parse($registration->created_at)->format('M d, Y') : 'N/A'); ?></td>
                                        <td>
                                            <span class="badge bg-success"><?php echo e(ucfirst($registration->status)); ?></span>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button type="button" class="btn btn-sm btn-info" 
                                                        onclick="viewRegistrationDetails('<?php echo e($registration->registration_id); ?>')">
                                                    <i class="bi bi-eye"></i> View
                                                </button>
                                            </div>
                                        </td>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <?php echo e((isset($history) && $history) ? 'Students Registration History' : 'Students with Pending Registration'); ?>

                    </h6>
                    <div>
                        <small class="text-muted">Total: <?php echo e($registrations->count()); ?></small>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php elseif($registration->status === 'rejected'): ?>
                                                <span class="badge bg-danger"><?php echo e(ucfirst($registration->status)); ?></span>
                                            <?php else: ?>
                                                <span class="badge bg-warning text-dark"><?php echo e(ucfirst($registration->status ?? 'pending')); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <?php if(isset($history) && $history): ?>
                                                    ...
                                                    <?php if($registration->status === 'approved'): ?>
                                                        <button type="button" class="btn btn-sm btn-warning" 
                                                                onclick="undoApproval('<?php echo e($registration->registration_id); ?>')">
                                                            <i class="bi bi-arrow-counterclockwise"></i> Undo
                                                        </button>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-success" 
                                                            onclick="approveRegistration('<?php echo e($registration->registration_id); ?>')">
                                                        <i class="bi bi-check-circle"></i> Approve
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-info" 
                                                            onclick="viewRegistrationDetails('<?php echo e($registration->registration_id); ?>')">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-danger" 
                                                            onclick="rejectRegistration('<?php echo e($registration->registration_id); ?>')">
                                                        <i class="bi bi-x-circle"></i> Reject
                                                    </button>
                                                <?php endif; ?>
                                            </div>
                    ...
                    <?php else: ?>
                        <div class="text-center py-4">
                            ...
                            <h5 class="mt-3 text-muted">
                                <?php echo e((isset($history) && $history) ? 'No Registration History' : 'No Pending Registrations'); ?>

                            </h5>
                            <p class="text-muted">
                                <?php echo e((isset($history) && $history) ? 'No student registrations have been processed yet.' : 'All student registrations have been processed.'); ?>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="registrationModalLabel">
                        <i class="bi bi-file-earmark-text"></i> Registration Details
                    </h5>
...
const isHistory = '<?php echo e(isset($history) && $history ? "true" : "false"); ?>' === 'true';
...
<!-- Enhanced Registration Modal JavaScript -->
        <script src="<?php echo e(asset('js/enrollment/enhanced-registration-modal.js')); ?>"></script>

<!-- Confirmation Modal Template (will be created dynamically) -->

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/admin/admin-student-registration/admin-student-registration.blade.php ENDPATH**/ ?>