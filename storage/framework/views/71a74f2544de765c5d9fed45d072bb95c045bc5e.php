...
} elseif ($_instance->childHasBeenRendered('przrtjQ')) {
    $componentId = $_instance->getRenderedChildComponentId('przrtjQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('przrtjQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('przrtjQ');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('przrtjQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
