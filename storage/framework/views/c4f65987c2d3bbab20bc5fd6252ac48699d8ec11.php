        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="btn-group">
                    ...
                    <a href="<?php echo e(route('professor.attendance.reports')); ?>" class="btn btn-outline-primary">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('professor.attendance')); ?>" class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" id="date" name="date" 
                                   value="<?php echo e($selectedDate); ?>" required>
                        </div>
                        <div class="col-md-4">
            ...
            <?php if($selectedProgramId && $students->count() > 0): ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Record Attendance for <?php echo e($selectedDate); ?></h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('professor.attendance.store')); ?>">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="attendance[<?php echo e($index); ?>][student_id]" value="<?php echo e($student->student_id); ?>">
                                                    
                                                    <div class="btn-group" role="group">
                                                        <input type="radio" class="btn-check" 
                                                               name="attendance[<?php echo e($index); ?>][status]" 
                                                               id="present_<?php echo e($student->student_id); ?>" 
                                                               value="present"
                                                               <?php echo e(($existingAttendance && $existingAttendance->status == 'present') ? 'checked' : ''); ?>>
                                                        <label class="btn btn-outline-success btn-sm" 
                                                               for="present_<?php echo e($student->student_id); ?>">Present</label>

                                                        <input type="radio" class="btn-check" 
                                                               name="attendance[<?php echo e($index); ?>][status]" 
                                                               id="late_<?php echo e($student->student_id); ?>" 
                                                               value="late"
                                                               <?php echo e(($existingAttendance && $existingAttendance->status == 'late') ? 'checked' : ''); ?>>
                                                        <label class="btn btn-outline-warning btn-sm" 
                                                               for="late_<?php echo e($student->student_id); ?>">Late</label>

                                                        <input type="radio" class="btn-check" 
                                                               name="attendance[<?php echo e($index); ?>][status]" 
                                                               id="absent_<?php echo e($student->student_id); ?>" 
                                                               value="absent"
                                                               <?php echo e(($existingAttendance && $existingAttendance->status == 'absent') || !$existingAttendance ? 'checked' : ''); ?>>
                                                        <label class="btn btn-outline-danger btn-sm" 
                                                               for="absent_<?php echo e($student->student_id); ?>">Absent</label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" 
                                                           name="attendance[<?php echo e($index); ?>][notes]"
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3">
                                <div class="text-muted">
                                    <small>Total Students: <?php echo e($students->count()); ?></small>
                                </div>
...
<div class="modal fade" id="createMeetingModal" tabindex="-1" aria-labelledby="createMeetingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="createMeetingForm" action="<?php echo e(route('admin.meetings.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('professor.professor-layouts.professor-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\professor\attendance\index.blade.php ENDPATH**/ ?>