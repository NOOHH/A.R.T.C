...
Route::post('/test-upload-v2', function (Request $request) {
    Log::info('🧪 TEST UPLOAD V2 ROUTE HIT');
...
Route::post('/test-upload', function (Request $request) {
    ...
    if ($request->hasFile('attachment')) {
        ...
        Log::info('🧪 TEST FILE STORAGE RESULT', [
            'storeAs_result' => $path,
...
R o u t e : : p o s t ( ' / t e s t - u p l o a d ' ,   f u n c t i o n ( \ I l l u m i n a t e \ H t t p \ R e q u e s t   $ r e q u e s t )   { 
         \ I l l u m i n a t e \ S u p p o r t \ F a c a d e s \ L o g : : i n f o ( ' T E S T   U P L O A D ' ,   [ 
                 ' h a s _ f i l e '   = >   $ r e q u e s t - > h a s F i l e ( ' a t t a c h m e n t ' ) , 
                 ' f i l e s _ c o u n t '   = >   c o u n t ( $ r e q u e s t - > f i l e s - > a l l ( ) ) , 
                 ' f i l e _ k e y s '   = >   a r r a y _ k e y s ( $ r e q u e s t - > f i l e s - > a l l ( ) ) , 
                 ' a l l _ i n p u t '   = >   $ r e q u e s t - > a l l ( ) 
         ] ) ; 
         
         i f   ( $ r e q u e s t - > h a s F i l e ( ' a t t a c h m e n t ' ) )   { 
                 $ f i l e   =   $ r e q u e s t - > f i l e ( ' a t t a c h m e n t ' ) ; 
                 $ p a t h   =   $ f i l e - > s t o r e A s ( ' t e s t ' ,   t i m e ( )   .   ' _ '   .   $ f i l e - > g e t C l i e n t O r i g i n a l N a m e ( ) ,   ' p u b l i c ' ) ; 
                 r e t u r n   r e s p o n s e ( ) - > j s o n ( [ ' s u c c e s s '   = >   t r u e ,   ' p a t h '   = >   $ p a t h ] ) ; 
         } 
         
         r e t u r n   r e s p o n s e ( ) - > j s o n ( [ ' s u c c e s s '   = >   f a l s e ,   ' m e s s a g e '   = >   ' N o   f i l e   d e t e c t e d ' ] ) ; 
 } ) - > n a m e ( ' t e s t . u p l o a d ' ) ; 
 
 