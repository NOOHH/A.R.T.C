...
<link rel="stylesheet" href="<?php echo e(asset('css/admin/admin-settings/admin-settings.css')); ?>">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="loginCustomizationForm" method="POST" action="<?php echo e(route('admin.settings.update.login')); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="mb-3">
                                                ...
                                                <input type="color" class="form-control form-control-color" name="login_background_color" 
                                                       value="<?php echo e($settings['login']['background_color'] ?? '#8e24aa'); ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="color" class="form-control form-control-color" name="login_gradient_color" 
                                                       value="<?php echo e($settings['login']['gradient_color'] ?? '#b0004c'); ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="color" class="form-control form-control-color" name="login_accent_color" 
                                                       value="<?php echo e($settings['login']['accent_color'] ?? '#b0004c'); ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="color" class="form-control form-control-color" name="login_text_color" 
                                                       value="<?php echo e($settings['login']['text_color'] ?? '#333333'); ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="color" class="form-control form-control-color" name="login_card_background" 
                                                       value="<?php echo e($settings['login']['card_background'] ?? '#ffffff'); ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="color" class="form-control form-control-color" name="login_input_border_color" 
                                                       value="<?php echo e($settings['login']['input_border_color'] ?? '#dee2e6'); ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="color" class="form-control form-control-color" name="login_input_focus_color" 
                                                           value="<?php echo e($settings['login']['input_focus_color'] ?? '#667eea'); ?>" id="login_input_focus_color">
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="referralEnabled" name="referral_enabled" 
                                                           <?php echo e(DB::table('admin_settings')->where('setting_key', 'referral_enabled')->value('setting_value') === '1' ? 'checked' : ''); ?>>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="referralRequired" name="referral_required"
                                                           <?php echo e(DB::table('admin_settings')->where('setting_key', 'referral_required')->value('setting_value') === '1' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4 pt-3 border-top">
                                            ...
                                            <div class="d-flex gap-2 flex-wrap">
                                                <a href="<?php echo e(route('enrollment.full')); ?>" class="btn btn-outline-info btn-sm" target="_blank">
                                                    <i class="fas fa-external-link-alt"></i> Preview Full Form
                                                </a>
                                                <a href="<?php echo e(route('enrollment.modular')); ?>" class="btn btn-outline-info btn-sm" target="_blank">
                                    ...
                                    <div class="card-body">
                                        <form id="heroSectionForm">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="hero_title" rows="3"><?php echo e($settings['homepage']['hero_title'] ?? 'Review Smarter. Learn Better. Succeed Faster.'); ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Subtitle</label>
                                                <textarea class="form-control" name="hero_subtitle" rows="3"><?php echo e($settings['homepage']['hero_subtitle'] ?? 'At Ascendo Review and Training Center, we guide future licensed professionals toward exam success with expert-led reviews and flexible learning options.'); ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <form id="studentPortalForm" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="color" class="form-control form-control-color" name="primary_color" 
                                                       value="<?php echo e(App\Models\UiSetting::get('student_portal', 'primary_color', '#007bff')); ?>">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Background Color</label>
                                                <input type="color" class="form-control form-control-color" name="background_color" 
                                                       value="<?php echo e(App\Models\UiSetting::get('student_portal', 'background_color', '#f8f9fa')); ?>">
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="meetingCreationEnabled" name="meeting_creation_enabled"
                                                       <?php echo e(DB::table('admin_settings')->where('setting_key', 'meeting_creation_enabled')->value('setting_value') === '1' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="professorModuleManagementEnabled" name="professor_module_management_enabled"
                                                       <?php echo e(DB::table('admin_settings')->where('setting_key', 'professor_module_management_enabled')->value('setting_value') === '1' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="professorAnnouncementManagementEnabled" name="professor_announcement_management_enabled"
                                                       <?php echo e(DB::table('admin_settings')->where('setting_key', 'professor_announcement_management_enabled')->value('setting_value') === '1' ? 'checked' : ''); ?>>
                            ...
                            <form id="meetingWhitelistForm">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="text-muted small">
                                        <span id="selectedCount"><?php echo e(count(array_filter($whitelistedProfessors))); ?></span> professors selected
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form id="moduleManagementWhitelistForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="border rounded p-3" style="max-height: 300px; overflow-y: auto;">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $professorsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $professor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="module_professor_<?php echo e($professor->professor_id); ?>" 
                                                       name="whitelist_module_professors[]" 
                                                       value="<?php echo e($professor->professor_id); ?>"
                                                       <?php echo e(in_array($professor->professor_id, $whitelistedModuleProfessors) ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="module_professor_<?php echo e($professor->professor_id); ?>">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="text-muted small">
                                        <span id="selectedModuleCount"><?php echo e(count(array_filter($whitelistedModuleProfessors))); ?></span> professors selected
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form id="announcementManagementWhitelistForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="border rounded p-3" style="max-height: 300px; overflow-y: auto;">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $professors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $professor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" 
                                                       id="announcement_professor_<?php echo e($professor->professor_id); ?>" 
                                                       name="whitelist_announcement_professors[]" 
                                                       value="<?php echo e($professor->professor_id); ?>"
                                                       <?php echo e(in_array($professor->professor_id, $whitelistedAnnouncementProfessors) ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="announcement_professor_<?php echo e($professor->professor_id); ?>">
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="text-muted small">
                                        <span id="selectedAnnouncementCount"><?php echo e(count(array_filter($whitelistedAnnouncementProfessors))); ?></span> professors selected
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <form id="sidebarCustomizationForm" method="POST" action="<?php echo e(route('admin.settings.sidebar')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
                                        <label class="form-label">Background Color</label>
                                        <input type="color" class="form-control form-control-color" name="sidebar_background_color" value="<?php echo e($settings['sidebar']['background_color'] ?? '#2d1b69'); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Gradient Color</label>
                                        <input type="color" class="form-control form-control-color" name="sidebar_gradient_color" value="<?php echo e($settings['sidebar']['gradient_color'] ?? '#1a1340'); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Text Color</label>
                                        <input type="color" class="form-control form-control-color" name="sidebar_text_color" value="<?php echo e($settings['sidebar']['text_color'] ?? '#ffffff'); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Hover Color</label>
                                        <input type="color" class="form-control form-control-color" name="sidebar_hover_color" value="<?php echo e($settings['sidebar']['hover_color'] ?? '#a91d3a'); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Active Background Color</label>
                                        <input type="color" class="form-control form-control-color" name="sidebar_active_bg_color" value="<?php echo e($settings['sidebar']['active_bg_color'] ?? '#a91d3a'); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Active Text Color</label>
                                        <input type="color" class="form-control form-control-color" name="sidebar_active_text_color" value="<?php echo e($settings['sidebar']['active_text_color'] ?? '#ffffff'); ?>">
                                    </div>
                                    <button type="submit" class="btn btn-primary">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <form id="sidebarFooterCustomizationForm" method="POST" action="<?php echo e(route('admin.settings.sidebar')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
                                        <label class="form-label">Footer Background Color</label>
                                        <input type="color" class="form-control form-control-color" name="sidebar_footer_bg_color" value="<?php echo e($settings['sidebar']['footer_bg_color'] ?? '#2d1b69'); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Footer Text Color</label>
                                        <input type="color" class="form-control form-control-color" name="sidebar_footer_text_color" value="<?php echo e($settings['sidebar']['footer_text_color'] ?? '#ffffff'); ?>">
                                    </div>
                                    <div class="alert alert-info">
                                        <i class="fas fa-info-circle me-2"></i>
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/admin/admin-settings/admin-settings.blade.php ENDPATH**/ ?>