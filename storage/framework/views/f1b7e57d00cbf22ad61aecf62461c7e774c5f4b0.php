...
<?php $__env->startSection('title', 'Quiz Preview - ' . $quiz->quiz_title); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-play-circle"></i> Quiz Preview: <?php echo e($quiz->quiz_title); ?></h2>
...
<div class="quiz-simulation">
    <div class="quiz-header mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <div class="quiz-meta">
                    <span class="badge bg-info"><?php echo e($quiz->total_questions); ?> Questions</span>
        ...
        <?php if($quiz->instructions): ?>
            <div class="mt-3 p-3 bg-light rounded">
                ...
                <p class="mb-0 mt-1"><?php echo e($quiz->instructions); ?></p>
            </div>
        <?php endif; ?>
        ...
        <div class="quiz-progress mt-3">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <span>Progress: <span id="current-question">1</span> of <?php echo e($quiz->questions->count()); ?></span>
                <?php if($quiz->time_limit): ?>
                    <span>Time Remaining: <span id="time-remaining" class="text-warning fw-bold"><?php echo e($quiz->time_limit); ?>:00</span></span>
                <?php endif; ?>
            </div>
            <div class="progress">
                <div id="quiz-progress-bar" class="progress-bar" role="progressbar" style="width: <?php echo e($quiz->questions->count() > 0 ? (100 / $quiz->questions->count()) : 0); ?>%"></div>
            </div>
        </div>
    </div>
    ...
    <div id="questions-container">
        <?php $__currentLoopData = $quiz->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="question-card <?php echo e($index === 0 ? 'active' : 'd-none'); ?>" data-question-index="<?php echo e($index); ?>" data-question-id="<?php echo e($question->id); ?>">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h6 class="mb-0">Question <?php echo e($index + 1); ?> of <?php echo e($quiz->questions->count()); ?></h6>
                        <small><?php echo e($question->points ?? 1); ?> point(s)</small>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="question-options mt-4">
                                    ...
                                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="radio" name="question_<?php echo e($question->id); ?>" 
                                                   value="<?php echo e($key); ?>" id="q<?php echo e($question->id); ?>_<?php echo e($key); ?>">
                                            <label class="form-check-label" for="q<?php echo e($question->id); ?>_<?php echo e($key); ?>">
                            ...
                            <?php elseif($question->question_type === 'true_false'): ?>
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="question_<?php echo e($question->id); ?>" 
                                           value="A" id="q<?php echo e($question->id); ?>_true">
                                    <label class="form-check-label" for="q<?php echo e($question->id); ?>_true">
                                        <strong>True</strong>
                                    </label>
                                </div>
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="question_<?php echo e($question->id); ?>" 
                                           value="B" id="q<?php echo e($question->id); ?>_false">
                                    <label class="form-check-label" for="q<?php echo e($question->id); ?>_false">
                                        <strong>False</strong>
                                    </label>
                                </div>
                            ...
                            <?php elseif($question->question_type === 'short_answer'): ?>
                                <div class="mb-3">
                                    <textarea class="form-control" name="question_<?php echo e($question->id); ?>" 
                        ...
                        <div class="answer-feedback d-none mt-4" id="feedback_<?php echo e($question->id); ?>">
                            <div class="alert" id="feedback-alert_<?php echo e($question->id); ?>">
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-outline-secondary" 
                                    onclick="previousQuestion()" <?php echo e($index === 0 ? 'disabled' : ''); ?>>
                                <i class="bi bi-chevron-left"></i> Previous
                            </button>
                            
                            <?php if($quiz->instant_feedback): ?>
                                <button type="button" class="btn btn-primary" onclick="checkAnswer(<?php echo e($question->id); ?>)">
                                    Check Answer
                                </button>
                            <?php endif; ?>
                            
                            <button type="button" class="btn btn-primary" 
                                    onclick="nextQuestion()" <?php echo e($index === $quiz->questions->count() - 1 ? 'disabled' : ''); ?>>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><strong>Correct Answers:</strong> <span id="correct-count"></span> / <?php echo e($quiz->questions->count()); ?></li>
...
let totalQuestions = <?php echo e($quiz->questions->count()); ?>;
let userAnswers = {};
let quizStartTime = new Date();
let timeLimit = <?php echo e($quiz->time_limit ?? 0); ?>;
let timerInterval;
...
const quizData = {
    <?php $__currentLoopData = $quiz->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo e($question->id); ?>: {
            type: '<?php echo e($question->question_type); ?>',
            correct_answer: '<?php echo e($question->correct_answer); ?>',
            options: <?php echo json_encode(is_string($question->options) ? json_decode($question->options, true) : $question->options, 512) ?>,
            explanation: '<?php echo e($question->explanation); ?>',
            points: <?php echo e($question->points ?? 1); ?>
...
<?php echo $__env->make('professor.professor-layouts.professor-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\Quiz Generator\professor\quiz-preview-simulation.blade.php ENDPATH**/ ?>