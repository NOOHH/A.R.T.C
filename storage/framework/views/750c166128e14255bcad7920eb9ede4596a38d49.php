...
<div class="container py-4">
  ...
  <div class="card mb-4">
    <div class="card-body">
      <form method="POST" action="<?php echo e(route('admin.settings.auth-fields.set-identifier')); ?>" class="row g-2 align-items-end">
        <?php echo csrf_field(); ?>
        <div class="col-auto">
          <label class="form-label">Login Identifier</label>
          <select name="login_identifier" class="form-select">
            <option value="email" <?php echo e($loginIdentifier==='email' ? 'selected' : ''); ?>>Email</option>
            <option value="username" <?php echo e($loginIdentifier==='username' ? 'selected' : ''); ?>>Username</option>
          </select>
        </div>
        <div class="col-auto">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="<?php echo e(route('admin.settings.auth-fields.store')); ?>" class="row g-2 mb-3">
            <?php echo csrf_field(); ?>
          ...
          <ul class="list-group">
            <?php $__currentLoopData = $loginFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="list-group-item d-flex justify-content-between align-items-center">
              <div>
                <strong><?php echo e($f->label); ?></strong> <small class="text-muted">(<?php echo e($f->field_key); ?>)</small>
                <div class="text-muted">Type: <?php echo e($f->type); ?> • Required: <?php echo e($f->is_required ? 'Yes' : 'No'); ?> • Enabled: <?php echo e($f->is_enabled ? 'Yes' : 'No'); ?></div>
              </div>
              <form method="POST" action="<?php echo e(route('admin.settings.auth-fields.delete', $f)); ?>" onsubmit="return confirm('Delete field?')">
                <?php echo csrf_field(); ?>
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <ul class="list-group">
            <?php $__currentLoopData = $registerFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="list-group-item d-flex justify-content-between align-items-center">
              <div>
                <strong><?php echo e($f->label); ?></strong> <small class="text-muted">(<?php echo e($f->field_key); ?>)</small>
                <div class="text-muted">Type: <?php echo e($f->type); ?> • Required: <?php echo e($f->is_required ? 'Yes' : 'No'); ?> • Enabled: <?php echo e($f->is_enabled ? 'Yes' : 'No'); ?></div>
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\smartprep\admin\admin-settings\auth-fields.blade.php ENDPATH**/ ?>