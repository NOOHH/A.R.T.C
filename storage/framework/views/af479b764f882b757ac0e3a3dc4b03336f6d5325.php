                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <?php if(isset($settings['auth']['login_illustration_url']) && $settings['auth']['login_illustration_url']): ?>
                                                <div class="mt-2">
                                                    <small class="text-muted">Current illustration:</small><br>
                                                    <img src="<?php echo e($settings['auth']['login_illustration_url']); ?>" alt="Current illustration" style="max-height: 100px;" class="img-thumbnail">
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label">Copyright Text</label>
                                            <textarea class="form-control" name="login_copyright_text" rows="2" placeholder="© Copyright Your Company. All Rights Reserved."><?php echo e($settings['auth']['login_copyright_text'] ?? '© Copyright Ascendo Review and Training Center.\nAll Rights Reserved.'); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="color" class="form-control form-control-color" name="login_text_color" value="<?php echo e($settings['auth']['login_text_color'] ?? '#ffffff'); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="color" class="form-control form-control-color" name="login_copyright_color" value="<?php echo e($settings['auth']['login_copyright_color'] ?? '#ffffff'); ?>">
                                        </div>
                                    </div>
                                </div>
