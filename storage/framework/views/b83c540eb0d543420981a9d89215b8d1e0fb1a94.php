...
<div id="director-features" class="sidebar-section">
    ...
    <form id="directorFeaturesForm" action="<?php echo e(route('smartprep.dashboard.settings.update.director', ['website' => $selectedWebsite->id])); ?>" method="POST" onsubmit="updateDirectorFeatures(event)">
        <?php echo csrf_field(); ?>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="directorViewStudents" name="view_students" <?php echo e(($settings['director_features']['view_students'] ?? true) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="directorManagePrograms" name="manage_programs" <?php echo e(($settings['director_features']['manage_programs'] ?? false) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="directorManageModules" name="manage_modules" <?php echo e(($settings['director_features']['manage_modules'] ?? false) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="directorManageEnrollments" name="manage_enrollments" <?php echo e(($settings['director_features']['manage_enrollments'] ?? true) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="directorViewAnalytics" name="view_analytics" <?php echo e(($settings['director_features']['view_analytics'] ?? true) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="directorManageProfessors" name="manage_professors" <?php echo e(($settings['director_features']['manage_professors'] ?? false) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="directorManageAnnouncements" name="manage_announcements" <?php echo e(($settings['director_features']['manage_announcements'] ?? true) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="directorManageBatches" name="manage_batches" <?php echo e(($settings['director_features']['manage_batches'] ?? false) ? 'checked' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/smartprep/dashboard/partials/settings/director-features.blade.php ENDPATH**/ ?>