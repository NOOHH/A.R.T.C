...
<?php $__env->startSection('title', 'FAQ Management - Admin Dashboard'); ?>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h3 class="text-primary"><?php echo e(count($faqs)); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h3 class="text-success"><?php echo e(collect($faqs)->where('status', 'active')->count()); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h3 class="text-info"><?php echo e(collect($faqs)->sum('views')); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="category-card p-3 border rounded">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted"><?php echo e($category['count']); ?> FAQs</small>
                                    </div>
                                    <div class="category-actions">
                                        <button class="btn btn-sm btn-outline-primary" onclick="filterByCategory('<?php echo e($category['id']); ?>')">
                                            View
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium"><?php echo e($faq['question']); ?></div>
                                        <small class="text-muted"><?php echo e(Str::limit($faq['answer'], 50)); ?></small>
                                    </td>
                                    <td>
                                        <span class="badge bg-secondary"><?php echo e($faq['category']); ?></span>
                                    </td>
                                    <td>
                                        <span class="badge bg-<?php echo e($faq['status'] === 'active' ? 'success' : 'danger'); ?>">
                                            <?php echo e(ucfirst($faq['status'])); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e($faq['views']); ?></td>
                                    <td><?php echo e($faq['updated_at']); ?></td>
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <button class="btn btn-outline-primary" onclick="editFAQ(<?php echo e($faq['id']); ?>)">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <button class="btn btn-outline-success" onclick="previewFAQ(<?php echo e($faq['id']); ?>)">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                            <button class="btn btn-outline-danger" onclick="deleteFAQ(<?php echo e($faq['id']); ?>)">
...
function editFAQ(faqId) {
    ...
    const faqData = <?php echo json_encode($faqs, 15, 512) ?>.find(faq => faq.id === faqId);
    if (faqData) {
...
<?php echo $__env->make('admin.admin-dashboard.admin-dashboard-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/admin/faq/index.blade.php ENDPATH**/ ?>