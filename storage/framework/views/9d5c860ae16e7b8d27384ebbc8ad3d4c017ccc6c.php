...
<div class="sidebar-section" id="homepage-settings" style="display: none;">
    ...
    <form id="homepageForm" method="POST" action="<?php echo e(route('smartprep.dashboard.settings.update.homepage', ['website' => $selectedWebsite->id])); ?>" enctype="multipart/form-data" onsubmit="updateHomepage(event)">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views/smartprep/dashboard/partials/settings/homepage.blade.php ENDPATH**/ ?>