                                ...
                                <div class="program-info">
                                    ...
                                    <div class="enrollment-meta">
                                        ...
                                        <div class="meta-item">
                                            ...
                                            <span>Mode: {{ ucfirst($enrollment['learning_mode']) }}</span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="course-card">
                                                <div class="course-header">
                                                    ...
                                                    <div class="course-info">
                                                        ...
                                                        <div class="module-tag">{{ $course['module_name'] }}</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="course-meta">
                                                    <small>
                                                        ...
                                                        Added: {{ $course['enrolled_at'] }}
                                                    </small>
                                                </div>

                                                <div class="course-actions">
                                                    <a href="{{ route('student.course', ['courseId' => $course['program_id']]) }}" 
