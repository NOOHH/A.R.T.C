...
<div class="col-lg-6">
    ...
    <form method="POST" action="<?php echo e(route('smartprep.password.update')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\A.R.T.C\resources\views\smartprep\auth\passwords\reset.blade.php ENDPATH**/ ?>